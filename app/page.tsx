      ...
      <section id="purpose" className="py-12 bg-orange-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <Link href="/price/" className="inline-block bg-white border border-orange-400 text-orange-600 hover:bg-orange-100 font-bold py-3 px-8 rounded-lg transition-colors">
              料金相場【エリア別】を見る
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-2">
            {[
              ...
              { name: "和歌山", slug: "wakayama" }, { name: "高知", slug: "kochi" }, { name: "福井", slug: "fukui" },
              { name: "青森", slug: "aomori" }, { name: "秋田", slug: "akita" },
            ].map((c) => (
