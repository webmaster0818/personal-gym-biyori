...
export const metadata: Metadata = {
  title: "Dr.トレーニング 代々木店の口コミ・評判",
  description:
    "Dr.トレーニング 代々木店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Dr.トレーニング 代々木店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Dr.トレーニング代々木店の料金はいくらですか？", a: "Dr.トレーニング代々木店の料金は、都度払い制で1回60分7,100円（税込）〜が目安です。入会金は35,600円（税込）です。月額制プランも用意されています。最新の料金は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング代々木店のトレーナーは資格を持っていますか？", a: "はい、Dr.トレーニングのトレーナーは医学的知識を持つ有資格者が在籍しています。科学的根拠に基づいた指導を受けられます。" },
  { q: "Dr.トレーニング代々木店はストレッチ指導もありますか？", a: "はい、トレーニングに加えてストレッチ指導も行っています。身体の柔軟性向上やケガの予防にも力を入れています。" },
  { q: "Dr.トレーニング代々木店のアクセスは？", a: "代々木駅 徒歩3分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Dr.トレーニング 代々木店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Dr.トレーニング+代々木店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dr.トレーニング代々木店は、代々木駅から徒歩3分の好立地にあるパーソナルジムです。医学的根拠に基づいたトレーニングプログラムが特徴で、有資格トレーナーが一人ひとりの目標に合わせた指導を行います。都度払い制のため自分のペースで通えると好評です。
          </p>
