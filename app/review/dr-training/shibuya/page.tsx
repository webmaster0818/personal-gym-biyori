...
export const metadata: Metadata = {
  title: "Dr.トレーニング 渋谷店の口コミ・評判",
  description:
    "Dr.トレーニング 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Dr.トレーニング 渋谷店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Dr.トレーニング渋谷店の料金はいくらですか？", a: "Dr.トレーニング渋谷店の料金は、都度払い制で1回60分7,100円（税込）〜が目安です。入会金は35,600円（税込）です。月額制プランもあります。最新の料金は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング渋谷店の営業時間は？", a: "9:00〜22:00です。最新情報は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング渋谷店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング渋谷店のアクセスは？", a: "渋谷駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Dr.トレーニング 渋谷店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Dr.トレーニング+渋谷店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dr.トレーニング渋谷店は、渋谷駅から徒歩圏内にある好アクセスな店舗です。医学的根拠に基づいたトレーニングメソッドが特徴で、一人ひとりの身体の状態に合わせたオーダーメイドプログラムを提供しています。都度払い制で無駄なく通えると評判で、トレーニング初心者からアスリートまで幅広い層に支持されています。
          </p>
