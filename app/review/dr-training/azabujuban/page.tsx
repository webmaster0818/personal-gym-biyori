...
export const metadata: Metadata = {
  title: "Dr.トレーニング 麻布十番PREMIUM店の口コミ・評判",
  description:
    "Dr.トレーニング 麻布十番PREMIUM店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Dr.トレーニング 麻布十番PREMIUM店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Dr.トレーニング麻布十番PREMIUM店の料金はいくらですか？", a: "Dr.トレーニング麻布十番PREMIUM店の料金は、都度払い制で1回60分7,100円（税込）〜が目安です。入会金は35,600円（税込）です。月額制プランも用意されています。最新の料金は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング麻布十番PREMIUM店のトレーナーは資格を持っていますか？", a: "はい、Dr.トレーニングのトレーナーは医学的知識を持つ有資格者が在籍しています。科学的根拠に基づいた指導を受けられます。" },
  { q: "Dr.トレーニング麻布十番PREMIUM店はストレッチ指導もありますか？", a: "はい、トレーニングに加えてストレッチ指導も行っています。身体の柔軟性向上やケガの予防にも力を入れています。" },
  { q: "Dr.トレーニング麻布十番PREMIUM店のアクセスは？", a: "麻布十番駅 徒歩3分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="麻布十番PREMIUM店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        {/* ---------- H1 ---------- */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          Dr.トレーニング 麻布十番PREMIUM店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Dr.トレーニング 麻布十番PREMIUM店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Dr.トレーニング+麻布十番PREMIUM店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dr.トレーニング麻布十番PREMIUM店は、麻布十番駅から徒歩3分のプレミアム店舗です。医学的根拠に基づいたトレーニングプログラムに加え、プレミアムならではの上質な空間と設備が特徴です。ワンランク上のパーソナルトレーニング体験ができると好評です。
          </p>
