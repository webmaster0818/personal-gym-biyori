...
export const metadata: Metadata = {
  title: "Dr.トレーニング 恵比寿店の口コミ・評判",
  description:
    "Dr.トレーニング 恵比寿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Dr.トレーニング 恵比寿店" },
  { label: "住所", value: "東京都渋谷区恵比寿（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "JR恵比寿駅 徒歩約3分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Dr.トレーニング恵比寿店の料金はいくらですか？", a: "Dr.トレーニング恵比寿店の料金は、都度払い制で1回60分7,100円（税込）〜が目安です。入会金は35,600円（税込）です。月額制プランもあります。最新の料金は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング恵比寿店の営業時間は？", a: "9:00〜22:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "Dr.トレーニング恵比寿店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "Dr.トレーニング恵比寿店のアクセスは？", a: "JR恵比寿駅 徒歩約3分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Dr.トレーニング 恵比寿店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Dr.トレーニング+恵比寿店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Dr.トレーニング恵比寿店は、恵比寿駅から徒歩圏内に位置する本店です。医学的根拠に基づいたトレーニングメソッドが特徴で、BOC認定トレーナーが在籍しています。都度払い制で通いやすく、継続率が高いと評判です。姿勢改善やボディメイクだけでなく、リハビリやパフォーマンスアップにも対応している点が口コミで高く評価されています。
          </p>
