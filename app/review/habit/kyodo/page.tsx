...
export const metadata: Metadata = {
  title: "HABIT 経堂店の口コミ・評判",
  description:
    "HABIT 経堂店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "HABIT 経堂店" },
  { label: "住所", value: "東京都世田谷区経堂2-2" },
  { label: "最寄駅", value: "経堂駅 徒歩1分" },
  { label: "営業時間", value: "7:00〜23:00（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "HABIT 経堂店の料金はいくらですか？", a: "月額制で通いやすい料金体系です。最新の料金は公式サイトでご確認ください。" },
  { q: "HABIT 経堂店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "HABIT 経堂店は初心者でも大丈夫ですか？", a: "はい、初心者の方も多く通われています。トレーナーが一から丁寧に指導します。" },
  { q: "HABIT 経堂店の体験トレーニングはありますか？", a: "はい、体験トレーニングが用意されています。公式サイトから予約できます。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="経堂店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">HABIT 経堂店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">HABIT 経堂店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/HABIT+経堂" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            HABIT経堂店は、小田急線経堂駅から徒歩わずか1分という抜群の立地にあるパーソナルジムです。駅前の商店街が充実した生活利便性の高いエリアで、買い物ついでにトレーニングに立ち寄る方も多くいます。世田谷区の中でも住みやすさで人気の経堂エリアらしく、地元密着型のアットホームな雰囲気が特徴です。小田急線沿線で通いやすいパーソナルジムを探している方に最適な店舗です。
          </p>
