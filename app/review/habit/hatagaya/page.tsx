...
export const metadata: Metadata = {
  title: "HABIT 幡ヶ谷店の口コミ・評判",
  description:
    "HABIT 幡ヶ谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "HABIT 幡ヶ谷店" },
  { label: "住所", value: "東京都渋谷区幡ヶ谷2-1-4" },
  { label: "最寄駅", value: "幡ヶ谷駅 徒歩5分" },
  { label: "営業時間", value: "7:00〜23:00（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "HABIT 幡ヶ谷店の料金はいくらですか？", a: "月額制で通いやすい料金体系です。最新の料金は公式サイトでご確認ください。" },
  { q: "HABIT 幡ヶ谷店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "HABIT 幡ヶ谷店は初心者でも大丈夫ですか？", a: "はい、初心者の方も多く通われています。トレーナーが一から丁寧に指導します。" },
  { q: "HABIT 幡ヶ谷店の体験トレーニングはありますか？", a: "はい、体験トレーニングが用意されています。公式サイトから予約できます。" },
];
...
const relatedStores = [
  ...
  { name: "HABIT 渋谷松濤店", href: "/review/habit/shibuya/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="幡ヶ谷店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">HABIT 幡ヶ谷店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">HABIT 幡ヶ谷店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/HABIT+幡ヶ谷" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            HABIT幡ヶ谷店は、京王新線幡ヶ谷駅から徒歩5分の渋谷区に位置するパーソナルジムです。新宿から京王新線で1駅という利便性がありながら、穏やかな住宅街の落ち着いた雰囲気が魅力です。近隣に住むファミリー層や在宅ワーカーの利用が多く、日中の時間帯でも予約が取りやすいと好評です。代々木上原や初台からもアクセスしやすく、渋谷区西部エリアで気軽にパーソナルトレーニングを始めたい方におすすめです。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/HABIT%20%E5%B9%A1%E3%83%B6%E8%B0%B7%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">以前は大手ジムに通っていましたが、HABITに変えてから成果が出るスピードが全然違います。幡ヶ谷店のトレーナーさんは知識が豊富で、食事のアドバイスもしてくれます。</p>
              <p className="text-xs text-gray-400">-- 入会8ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">住宅街の中にあるので人目を気にせず通えるのが良いです。幡ヶ谷のHABITはマンツーマン指導で、自分のペースでトレーニングできます。月額制なので料金を気にせず通えるのもありがたいです。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">幡ヶ谷駅から近くて通いやすいです。月額制で回数を気にせず通えるので、週2〜3回ペースで利用しています。体脂肪率が3ヶ月で5%落ちました。</p>
