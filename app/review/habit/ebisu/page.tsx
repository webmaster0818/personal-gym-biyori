...
export const metadata: Metadata = {
  title: "HABIT 恵比寿店の口コミ・評判",
  description:
    "HABIT 恵比寿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "HABIT 恵比寿店" },
  { label: "住所", value: "東京都渋谷区恵比寿西1-32-14" },
...
const faqItems = [
  { q: "HABIT 恵比寿店の料金はいくらですか？", a: "月額制で通いやすい料金体系です。最新の料金は公式サイトでご確認ください。" },
  { q: "HABIT 恵比寿店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "HABIT 恵比寿店は初心者でも大丈夫ですか？", a: "はい、初心者の方も多く通われています。トレーナーが一から丁寧に指導します。" },
  { q: "HABIT 恵比寿店の体験トレーニングはありますか？", a: "はい、体験トレーニングが用意されています。公式サイトから予約できます。" },
];
...
const relatedStores = [
  ...
  { name: "HABIT 白金高輪店", href: "/review/habit/shirokanedai/" },
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">HABIT 恵比寿店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">HABIT 恵比寿店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/HABIT+恵比寿" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            HABIT恵比寿店は、恵比寿駅西口から徒歩3分の好立地にあるパーソナルジムです。洗練された恵比寿エリアにふさわしく、美意識の高い利用者が多いのが特徴です。ダイエットやボディメイクを目的とした女性利用者からの評判が特に高く、「おしゃれな街で楽しくトレーニングできる」という声が寄せられています。代官山や中目黒からも近く、周辺エリアに住む方にとっても通いやすい店舗です。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/HABIT%20%E6%81%B5%E6%AF%94%E5%AF%BF%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">以前は大手ジムに通っていましたが、HABITに変えてから成果が出るスピードが全然違います。恵比寿店のトレーナーさんは知識が豊富で、食事のアドバイスもしてくれます。</p>
              <p className="text-xs text-gray-400">-- 入会8ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">住宅街の中にあるので人目を気にせず通えるのが良いです。恵比寿のHABITはマンツーマン指導で、自分のペースでトレーニングできます。月額制なので料金を気にせず通えるのもありがたいです。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">恵比寿駅から近くて通いやすいです。月額制で回数を気にせず通えるので、週2〜3回ペースで利用しています。体脂肪率が3ヶ月で5%落ちました。</p>
