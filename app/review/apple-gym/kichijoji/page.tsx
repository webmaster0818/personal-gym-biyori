...
export const metadata: Metadata = {
  title: "Apple GYM（アップルジム）吉祥寺店の口コミ・評判",
  description:
    "Apple GYM（アップルジム）吉祥寺店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const basicInfo = [
  { label: "店舗名", value: "Apple GYM（アップルジム）吉祥寺店" },
  { label: "住所", value: "東京都武蔵野市（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "吉祥寺駅 徒歩5分" },
  { label: "営業時間", value: "7:00〜23:00（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "Apple GYM吉祥寺店の料金はいくらですか？", a: "月額24,200円〜（月4回）です。入会金は33,000円（税込）ですが、キャンペーン中は無料になる場合があります。最新の料金は公式サイトでご確認ください。" },
  { q: "Apple GYM吉祥寺店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "Apple GYM吉祥寺店の特徴は？", a: "海外式ボディメイクメソッドを取り入れた姿勢改善ベースのパーソナルトレーニングが特徴です。完全個室で食事指導付きのプランが用意されています。" },
  { q: "Apple GYM吉祥寺店は駅から近いですか？", a: "はい、吉祥寺駅から徒歩5分の好立地です。買い物のついでにも通いやすい場所にあります。" },
];
...
const relatedStores = [
  ...
  { name: "Apple GYM 町田店", href: "/review/apple-gym/machida/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "Apple GYM（アップルジム）", href: "/review/apple-gym/" }, { name: "吉祥寺店" }]} />
      <ReviewSummary gymName="吉祥寺店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Apple GYM（アップルジム）吉祥寺店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Apple GYM 吉祥寺店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/Apple+GYM+アップルジム+吉祥寺店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2>
          <p className="text-gray-700 leading-relaxed">Apple GYM吉祥寺店は吉祥寺駅から徒歩5分の好立地にある海外式ボディメイクパーソナルジムです。完全個室のプライベート空間で、姿勢改善をベースとしたトレーニングが受けられます。月額24,200円〜で全プラン食事指導付き。吉祥寺エリアで手頃な価格のパーソナルジムを探している方に人気です。</p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Apple+GYM+アップルジム+吉祥寺店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「吉祥寺の買い物ついでに通えるので継続しやすいです。海外式ボディメイクで姿勢から変わるのを実感しています。完全個室で集中できるのも良いです。」</p><p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「月額2万円台で食事指導までついているのはありがたいです。吉祥寺にはパーソナルジムが多いですが、コスパで選ぶならApple GYMだと思います。」</p><p className="text-xs text-gray-400">-- 利用歴4ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「運動が苦手な初心者ですが、トレーナーさんが丁寧に教えてくれるので安心です。姿勢が良くなってきたのを鏡で見るのが楽しみになりました。」</p><p className="text-xs text-gray-400">-- 入会2ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「朝早くから夜遅くまで営業しているので、自分のスケジュールに合わせやすいです。吉祥寺駅からも近く、天気が悪い日も通いやすいのが継続のポイントです。」</p><p className="text-xs text-gray-400">-- 利用歴6ヶ月のユーザー</p></div>
          </div>
        </section>
