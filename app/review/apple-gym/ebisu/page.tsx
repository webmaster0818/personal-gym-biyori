...
export const metadata: Metadata = {
  title: "Apple GYM（アップルジム）恵比寿店の口コミ・評判",
  description:
    "Apple GYM（アップルジム）恵比寿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const basicInfo = [
  { label: "店舗名", value: "Apple GYM（アップルジム）恵比寿店" },
...
const faqItems = [
  { q: "Apple GYM恵比寿店の料金はいくらですか？", a: "月額24,200円〜（月4回）です。入会金は33,000円（税込）ですが、キャンペーン中は無料になる場合があります。最新の料金は公式サイトでご確認ください。" },
  { q: "Apple GYM恵比寿店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "Apple GYM恵比寿店の特徴は？", a: "海外式ボディメイクメソッドを取り入れた姿勢改善ベースのパーソナルトレーニングが特徴です。恵比寿駅から徒歩3分の好立地で、完全個室・食事指導付きです。" },
  { q: "Apple GYM恵比寿店は朝早くから通えますか？", a: "はい、朝7時から営業しています。出勤前にトレーニングしたい方にも便利な営業時間です。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "Apple GYM（アップルジム）", href: "/review/apple-gym/" }, { name: "恵比寿店" }]} />
      <ReviewSummary gymName="恵比寿店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Apple GYM（アップルジム）恵比寿店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Apple GYM 恵比寿店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/Apple+GYM+アップルジム+恵比寿店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2>
          <p className="text-gray-700 leading-relaxed">Apple GYM恵比寿店は恵比寿駅から徒歩3分という抜群のアクセスを誇る海外式ボディメイクパーソナルジムです。完全個室のトレーニング環境で、姿勢改善をベースとしたボディメイクが特徴です。月額24,200円〜で全プラン食事指導付き。恵比寿エリアの美意識の高い利用者に支持されています。</p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Apple+GYM+アップルジム+恵比寿店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「恵比寿駅から徒歩3分で通いやすさは抜群です。海外式ボディメイクで姿勢から変えるアプローチが気に入っています。2ヶ月で周りから変わったねと言われるようになりました。」</p><p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「完全個室でトレーナーさんとマンツーマンなので、恥ずかしさを感じることなくトレーニングに集中できます。食事指導も自分の生活スタイルに合わせてくれるので続けやすいです。」</p><p className="text-xs text-gray-400">-- 利用歴5ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「恵比寿のパーソナルジムは高額なところが多い中、月額2万円台で始められるのは魅力的です。トレーナーさんの質も高く、コスパの良さを実感しています。」</p><p className="text-xs text-gray-400">-- 入会2ヶ月のユーザー</p></div>
            <div className="bg-white border border-gray-200 rounded-lg p-4"><p className="text-sm text-gray-700 leading-relaxed mb-2">「朝7時からやっているので、出勤前に恵比寿店でトレーニングしています。朝のトレーニングは1日の調子が良くなるので習慣化できて良かったです。」</p><p className="text-xs text-gray-400">-- 利用歴4ヶ月のユーザー</p></div>
          </div>
        </section>
