...
export const metadata: Metadata = {
  ...
  description:
    "Apple GYM（アップルジム）新宿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const faqItems = [
  { q: "Apple GYM新宿店の料金はいくらですか？", a: "月額24,200円〜（月4回）です。入会金は33,000円（税込）ですが、キャンペーン中は無料になる場合があります。最新の料金は公式サイトでご確認ください。" },
  { q: "Apple GYM新宿店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "Apple GYM新宿店の特徴は？", a: "海外式ボディメイクメソッドを取り入れた姿勢改善ベースのパーソナルトレーニングが特徴です。完全個室で食事指導付きのプランが用意されています。" },
  { q: "Apple GYM新宿店は女性でも通いやすいですか？", a: "はい、完全個室のため人目を気にせずトレーニングできます。姿勢改善やボディライン作りを目的とした女性利用者も多い店舗です。" },
];
...
const relatedStores = [
  ...
  { name: "Apple GYM 池袋店", href: "/review/apple-gym/ikebukuro/" },
    ...
    <>
      ...
      <Breadcrumb
        items={[
          ...
          { name: "Apple GYM（アップルジム）", href: "/review/apple-gym/" },
          { name: "新宿店" },
        ]}
      />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Apple GYM 新宿店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/Apple+GYM+アップルジム+新宿店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
