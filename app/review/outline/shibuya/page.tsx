...
const faqItems = [
  ...
  { q: "OUTLINE渋谷店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "OUTLINE渋谷店のアクセスは？", a: "渋谷駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              OUTLINE 渋谷店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/OUTLINE+渋谷店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            OUTLINE渋谷店は、渋谷駅から徒歩圏内にある女性専用パーソナルジムです。完全個室・完全予約制で、周囲の目を気にせずトレーニングに集中できる環境が整っています。女性トレーナーによるきめ細やかな指導が好評で、ダイエットやボディメイクを目的とした20代〜40代の女性に支持されています。生涯アフターフォロー付きでリバウンド防止にも力を入れています。
          </p>
