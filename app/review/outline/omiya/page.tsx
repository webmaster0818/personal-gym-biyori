...
const faqItems = [
  ...
  { q: "OUTLINE大宮店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              OUTLINE 大宮店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/OUTLINE+大宮店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            OUTLINE大宮店は、大宮駅から徒歩圏内にある女性専用パーソナルジムです。埼玉県内で女性専用の本格的なパーソナルトレーニングを受けられる数少ない店舗として、さいたま市を中心に幅広いエリアの女性から支持されています。完全個室で人目を気にせずトレーニングでき、生涯アフターフォローでリバウンド防止もサポートしてくれます。
          </p>
