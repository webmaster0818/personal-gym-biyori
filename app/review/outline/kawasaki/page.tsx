...
const faqItems = [
  ...
  { q: "OUTLINE川崎店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
...
const relatedStores = [
  ...
  { name: "OUTLINE 町田店", href: "/review/outline/machida/" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              OUTLINE 川崎店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/OUTLINE+川崎店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            OUTLINE川崎店は、川崎駅から徒歩圏内にある女性専用パーソナルジムです。神奈川県内で本格的な女性専用パーソナルトレーニングを受けられる店舗として人気があります。完全個室の落ち着いた空間で、産後ダイエットやウエディング前のボディメイクなど、女性ならではの目標に寄り添った指導が口コミで高く評価されています。
          </p>
