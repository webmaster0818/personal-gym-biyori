...
const faqItems = [
  ...
  { q: "OUTLINE町田店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              OUTLINE 町田店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/OUTLINE+町田店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            OUTLINE町田店は、町田駅から徒歩圏内にある女性専用パーソナルジムです。都心まで出なくても本格的なパーソナルトレーニングを受けられると、多摩地域の女性から支持されています。完全個室でプライバシーが守られる環境と、女性トレーナーによる親身な指導が口コミで好評です。生涯アフターフォロー付きでリバウンド対策も万全です。
          </p>
