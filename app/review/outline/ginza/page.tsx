...
export const metadata: Metadata = {
  title: "OUTLINE 銀座店の口コミ・評判",
  description:
    "OUTLINE 銀座店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "OUTLINE 銀座店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "OUTLINE銀座店の料金はいくらですか？", a: "OUTLINE銀座店の料金は、2ヶ月コースで184,800円（税込）〜が目安です。入会金は33,000円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "OUTLINE銀座店の営業時間は？", a: "8:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "OUTLINE銀座店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "OUTLINE銀座店のアクセスは？", a: "東京メトロ銀座駅 徒歩約3分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              OUTLINE 銀座店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/OUTLINE+銀座店"
              target="_blank"
