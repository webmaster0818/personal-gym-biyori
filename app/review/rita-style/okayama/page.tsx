...
export const metadata: Metadata = {
  title: "RITA STYLE 岡山店の口コミ・評判",
  description:
    "RITA STYLE 岡山店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "RITA STYLE 岡山店" },
  { label: "住所", value: "岡山市北区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "岡山駅 徒歩10分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "RITA STYLE岡山店の料金はいくらですか？", a: "2ヶ月コース（16回）が156,200円（税込）〜です。食事指導付きのフルサポートプランです。最新の料金は公式サイトでご確認ください。" },
  { q: "RITA STYLE岡山店では食事指導を受けられますか？", a: "はい、毎日の食事をLINEで報告し、専門スタッフからアドバイスを受けられます。過度な食事制限は行わず、3食しっかり食べながらボディメイクを目指します。" },
  { q: "RITA STYLE岡山店に返金保証はありますか？", a: "はい、30日間全額返金保証があります。効果に満足できなかった場合に適用されます。詳細はカウンセリング時にご確認ください。" },
  { q: "RITA STYLE岡山店の無料体験はありますか？", a: "無料カウンセリング・体験トレーニングが用意されています。公式サイトから予約できます。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="岡山店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          RITA STYLE 岡山店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              RITA STYLE 岡山店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/RITA+STYLE+岡山店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            RITA STYLE岡山店は、岡山駅から徒歩10分の場所にある中国地方のRITA STYLE店舗です。2ヶ月156,200円〜という低価格ながら食事指導付きのフルサポートが受けられる点が好評です。岡山エリアでは大手パーソナルジムの進出が少ない中、リーズナブルな価格で完全個室マンツーマン指導が受けられる点が魅力です。九州発のジムながら中国地方にも展開しており、岡山でコスパの良いパーソナルジムを探している方に支持されています。
          </p>
