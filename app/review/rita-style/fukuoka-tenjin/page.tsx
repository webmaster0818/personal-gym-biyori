...
export const metadata: Metadata = {
  title: "RITA STYLE 福岡天神店の口コミ・評判",
  description:
    "RITA STYLE 福岡天神店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "RITA STYLE 福岡天神店" },
  { label: "住所", value: "福岡市中央区（※最新情報は公式サイトでご確認ください）" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "RITA STYLE福岡天神店の料金はいくらですか？", a: "2ヶ月コース（16回）が156,200円（税込）〜です。食事指導付きのフルサポートプランです。最新の料金は公式サイトでご確認ください。" },
  { q: "RITA STYLE福岡天神店では食事指導を受けられますか？", a: "はい、毎日の食事をLINEで報告し、専門スタッフからアドバイスを受けられます。過度な食事制限は行わず、3食しっかり食べながらボディメイクを目指します。" },
  { q: "RITA STYLE福岡天神店に返金保証はありますか？", a: "はい、30日間全額返金保証があります。効果に満足できなかった場合に適用されます。詳細はカウンセリング時にご確認ください。" },
  { q: "RITA STYLE福岡天神店の無料体験はありますか？", a: "無料カウンセリング・体験トレーニングが用意されています。公式サイトから予約できます。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="福岡天神店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        {/* ---------- H1 ---------- */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          RITA STYLE 福岡天神店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              RITA STYLE 福岡天神店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/RITA+STYLE+福岡天神店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/RITA-STYLE%20STYLE%20%E7%A6%8F%E5%B2%A1%E5%A4%A9%E7%A5%9E%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">STYLE 福岡天神のRITA STYLEに通っていますが、食事指導のおかげで3ヶ月で5kg減量できました。九州エリアでこの価格帯のパーソナルジムは貴重だと思います。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">九州発のパーソナルジムということで地元密着の安心感があります。STYLE 福岡天神店は食事指導が手厚く、毎日の食事をLINEで報告するとすぐにフィードバックがもらえます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            RITA STYLE福岡天神店は、天神駅から徒歩5分の好立地にある九州発パーソナルジムの主力店舗です。2ヶ月156,200円〜という低価格ながら食事指導付きのフルサポートが受けられる点が好評です。完全個室でのマンツーマン指導に加え、LINEでの毎日の食事サポートにより、運動初心者や食事管理が苦手な方からも高い満足度を得ています。福岡エリアでコスパの良いパーソナルジムを探している方に特に支持されています。
          </p>
