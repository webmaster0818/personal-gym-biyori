...
export const metadata: Metadata = {
  title: "REXER 渋谷店の口コミ・評判",
  description:
    "REXER 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "REXER 渋谷店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "REXER渋谷店の料金はいくらですか？", a: "REXERはオーダーメイドのトレーニングプランを提供しており、料金はプランにより異なります。最新の料金は公式サイトでご確認ください。" },
  { q: "REXER渋谷店の最寄駅はどこですか？", a: "渋谷駅から徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "REXER渋谷店のトレーナーの特徴は？", a: "経験豊富なトレーナーがマンツーマンで指導します。個人の目標や体質に合わせたオーダーメイドプログラムが特徴です。" },
  { q: "REXER渋谷店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              REXER 渋谷店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/REXER+渋谷店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/REXER%20%E6%B8%8B%E8%B0%B7%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">プレミアムな空間で、オーダーメイドのトレーニングプログラムを組んでもらえます。渋谷店は内装も高級感があり、モチベーションが上がります。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">REXERは他のジムとは一線を画すプレミアムなサービスです。渋谷店のトレーナーは経験豊富で、体の状態を見ながら柔軟にメニューを調整してくれます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            REXER渋谷店は渋谷駅から徒歩5分の好アクセスに位置するパーソナルジムです。完全個室のトレーニング空間で、周りの目を気にせず集中してトレーニングに取り組めると好評です。特にダイエット目的の利用者からの支持が高く、食事管理と運動の両面からサポートしてもらえる点が評価されています。渋谷エリアで働くビジネスパーソンの利用が多い店舗です。
          </p>
