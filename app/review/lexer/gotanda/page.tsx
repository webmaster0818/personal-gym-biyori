...
export const metadata: Metadata = {
  ...
  title: "REXER 五反田店の口コミ・評判",
  description:
    "REXER 五反田店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "REXER 五反田店" },
  { label: "住所", value: "東京都品川区東五反田1-14-11（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "五反田駅 徒歩1分" },
  { label: "営業時間", value: "※公式サイトでご確認ください" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "REXER五反田店の料金はいくらですか？", a: "REXERはオーダーメイドのトレーニングプランを提供しており、料金はプランにより異なります。最新の料金は公式サイトでご確認ください。" },
  { q: "REXER五反田店の最寄駅はどこですか？", a: "五反田駅から徒歩1分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "REXER五反田店のトレーナーの特徴は？", a: "経験豊富なトレーナーがマンツーマンで指導します。個人の目標や体質に合わせたオーダーメイドプログラムが特徴です。" },
  { q: "REXER五反田店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "REXER", href: "/review/lexer/" }, { name: "五反田店" }]} />
      <ReviewSummary gymName="五反田店" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">REXER 五反田店の口コミ・評判</h1>
        ...
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2><div className="bg-gray-100 rounded-lg p-8 text-center"><p className="text-gray-600 mb-4">REXER 五反田店の所在地をGoogleマップで確認できます。</p><a href="https://www.google.com/maps/search/REXER+五反田店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a></div></section>
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2><p className="text-gray-700 leading-relaxed">REXER五反田店は五反田駅から徒歩1分という駅直結級のアクセスが魅力のパーソナルジムです。プライベート空間でオーダーメイドのトレーニングが受けられると評判で、五反田エリアのビジネスパーソンに人気です。トレーナーの指導が丁寧で初心者でも安心して通えます。</p><p className="text-xs text-gray-500 mt-4 bg-gray-50 rounded p-3">※口コミはGoogleマップの投稿を参考に要約・再構成したものです。個人の感想であり、効果を保証するものではありません。</p></section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/REXER%20%E4%BA%94%E5%8F%8D%E7%94%B0%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">プレミアムな空間で、オーダーメイドのトレーニングプログラムを組んでもらえます。五反田店は内装も高級感があり、モチベーションが上がります。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">REXERは他のジムとは一線を画すプレミアムなサービスです。五反田店のトレーナーは経験豊富で、体の状態を見ながら柔軟にメニューを調整してくれます。</p>
