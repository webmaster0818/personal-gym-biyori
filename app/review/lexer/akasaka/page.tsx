...
export const metadata: Metadata = {
  ...
  title: "REXER 赤坂店の口コミ・評判",
  description:
    "REXER 赤坂店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "REXER 赤坂店" },
  { label: "住所", value: "東京都港区赤坂3-10-5（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "赤坂見附駅 徒歩2分" },
  { label: "営業時間", value: "※公式サイトでご確認ください" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "REXER赤坂店の料金はいくらですか？", a: "REXERはオーダーメイドのトレーニングプランを提供しており、料金はプランにより異なります。最新の料金は公式サイトでご確認ください。" },
  { q: "REXER赤坂店の最寄駅はどこですか？", a: "赤坂見附駅から徒歩2分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "REXER赤坂店のトレーナーの特徴は？", a: "経験豊富なトレーナーがマンツーマンで指導します。個人の目標や体質に合わせたオーダーメイドプログラムが特徴です。" },
  { q: "REXER赤坂店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
...
const relatedStores = [
  ...
  { name: "REXER 五反田店", href: "/review/lexer/gotanda/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "REXER", href: "/review/lexer/" }, { name: "赤坂店" }]} />
      <ReviewSummary gymName="赤坂店" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">REXER 赤坂店の口コミ・評判</h1>
