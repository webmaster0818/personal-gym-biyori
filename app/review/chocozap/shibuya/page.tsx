...
export const metadata: Metadata = {
  title: "chocoZAP 渋谷店の口コミ・評判",
  description:
    "chocoZAP 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "chocoZAP 渋谷店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "chocoZAP渋谷店の料金はいくらですか？", a: "chocoZAP渋谷店の料金は、月額3,278円（税込）で全店舗通い放題です。入会金・事務手数料は各2,200円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "chocoZAP渋谷店の営業時間は？", a: "24時間営業です。※最新情報は公式サイトでご確認ください）" },
  { q: "chocoZAP渋谷店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "chocoZAP渋谷店のアクセスは？", a: "JR渋谷駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              chocoZAP 渋谷店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/chocoZAP+渋谷店"
              target="_blank"
