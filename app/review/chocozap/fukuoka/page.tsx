...
export const metadata: Metadata = {
  title: "chocoZAP 福岡店の口コミ・評判",
  description:
    "chocoZAP 福岡店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "chocoZAP 福岡店" },
  { label: "住所", value: "福岡県福岡市（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "天神駅 徒歩約3分" },
  { label: "営業時間", value: "24時間営業（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "chocoZAP福岡店の料金はいくらですか？", a: "chocoZAP福岡店の料金は、月額3,278円（税込）で全店舗通い放題です。入会金・事務手数料は各2,200円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "chocoZAP福岡店の営業時間は？", a: "24時間営業です。最新情報は公式サイトでご確認ください。" },
  { q: "chocoZAP福岡店にはどんな設備がありますか？", a: "トレーニングマシン、セルフエステ、セルフ脱毛などの設備が利用できます。店舗により設備が異なる場合がありますので、アプリでご確認ください。" },
  { q: "chocoZAP福岡店のアクセスは？", a: "天神駅 徒歩約3分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  { name: "chocoZAP 渋谷店", href: "/review/chocozap/shibuya/" },
  { name: "chocoZAP 梅田店", href: "/review/chocozap/umeda/" },
  { name: "chocoZAP 名古屋店", href: "/review/chocozap/nagoya/" },
];
    ...
    <>
      ...
      <Breadcrumb
        items={[
          ...
          { name: "chocoZAP", href: "/review/chocozap/" },
          { name: "福岡店" },
        ]}
      />
      <ReviewSummary gymName="福岡店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">chocoZAP 福岡店の口コミ・評判</h1>
        ...
        <div className="mb-10 text-center">
          <Link href="/review/chocozap/" className="inline-block bg-teal-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-teal-700 transition-colors text-sm">総合レビューを見る</Link>
        </div>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2>
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">chocoZAP 福岡店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/chocoZAP+福岡店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2>
          <p className="text-gray-700 leading-relaxed">chocoZAP福岡店は、博多駅近くにある24時間営業のコンビニジムです。九州エリアでRIZAP監修のトレーニングを月額3,278円で利用できると好評です。着替え不要・靴履き替え不要で、仕事帰りにスーツのままでも気軽に運動できるスタイルが、福岡の忙しいビジネスパーソンから支持されています。</p>
