...
const basicInfo = [
  ...
  { label: "住所", value: "福岡県京都郡苅田町（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "苅田駅（※最新情報は公式サイトでご確認ください）" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href={"https://www.google.com/maps/search/FURDI+ファディー+苅田店"} target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">苅田町で女性専用のジムに通えるのは嬉しいです。AI指導で正しいフォームが学べます。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額7,678円〜で通い放題なのがコスパ最高です。予約不要なのも便利です。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">苅田町で女性専用・AI指導のフィットネスジムはここだけです。この価格帯で通い放題は他にありません。</p>
