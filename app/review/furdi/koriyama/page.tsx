...
export const metadata: Metadata = {
  title: "FURDI 郡山八山田店の口コミ・評判",
  description:
    "FURDI（ファディー）郡山八山田店の口コミ・評判を紹介。AI指導・女性専用サーキット型フィットネスの基本情報から利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "FURDI（ファディー）郡山八山田店" },
...
const faqItems = [
  { q: "FURDI郡山八山田店の月額料金はいくらですか？", a: "FURDI郡山八山田店は月額7,678円〜で通い放題です。プランにより異なりますので、最新の料金は公式サイトでご確認ください。" },
  { q: "FURDI郡山八山田店はAI指導ですか？", a: "はい、大型モニターにAIトレーナーが表示され、フォームの指導やメニューの提案を行います。200種類以上のトレーニングメニューが用意されています。" },
  { q: "FURDI郡山八山田店は予約が必要ですか？", a: "いいえ、予約不要で好きな時間に通えます。サーキット型のトレーニングなので、自分のペースで取り組めます。" },
  { q: "FURDI郡山八山田店は男性も利用できますか？", a: "いいえ、FURDIは女性専用のフィットネスジムです。女性だけの空間で安心してトレーニングできます。" },
];
...
const relatedStores = [
  { name: "FURDI 郡山鶴見坦店", href: "/review/furdi/koriyama-tsurumitan/" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">FURDI 郡山八山田店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/FURDI+ファディー+郡山八山田店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FURDI郡山八山田店は、福島県郡山市にある女性専用AIフィットネスジムです。月額7,678円〜という低価格で通い放題のサーキット型トレーニングが特徴。AIトレーナーが画面上でフォームを指導してくれるため、人目を気にせず自分のペースでトレーニングできると好評です。郡山市の八山田エリアにあり、車でのアクセスも便利です。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href={"https://www.google.com/maps/search/FURDI+ファディー+郡山八山田店"} target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">郡山でAI指導のジムに通えるのは嬉しいです。女性専用で安心してトレーニングに集中できます。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額7,678円〜で通い放題なのがコスパ最高です。予約不要なので、自分の都合に合わせて通えます。</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">サーキット型で短時間でも効果的に全身を動かせます。女性だけの空間なので気兼ねなく運動できます。</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">AIトレーナーが丁寧にフォームをチェックしてくれます。200種類以上のメニューで飽きずに続けられます。</p>
              <p className="text-xs text-gray-400">-- 入会2ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">八山田エリアにあるので車で通いやすいです。この価格帯で女性専用・通い放題のジムは他にありません。</p>
