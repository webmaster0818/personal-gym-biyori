      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FURDI仙台店は、仙台駅から徒歩5分の女性専用AIフィットネスジムです。東北最大の都市・仙台で、地元の女性を中心に利用されています。AIトレーナーが200種類以上のメニューから最適なプログラムを提案し、運動初心者でも安心してトレーニングに取り組めます。月額7,678円〜で通い放題、予約不要のシステムが、仕事や家事で忙しい仙台の女性たちに好評です。
          </p>
