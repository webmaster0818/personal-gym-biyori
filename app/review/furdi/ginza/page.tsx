...
export const metadata: Metadata = {
  title: "FURDI 銀座店の口コミ・評判",
  description:
    "FURDI（ファディー）銀座店の口コミ・評判を紹介。AI指導・女性専用サーキット型フィットネスの基本情報から利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "FURDI（ファディー）銀座店" },
  { label: "住所", value: "東京都中央区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "銀座駅 徒歩3分" },
  { label: "営業時間", value: "6:00〜23:00（※最新情報は公式サイトでご確認ください）" },
  { label: "月額料金", value: "月額7,678円〜" },
];

const faqItems = [
  { q: "FURDI銀座店の月額料金はいくらですか？", a: "FURDI銀座店は月額7,678円〜で通い放題です。プランにより異なりますので、最新の料金は公式サイトでご確認ください。" },
  { q: "FURDI銀座店はAI指導ですか？", a: "はい、大型モニターにAIトレーナーが表示され、フォームの指導やメニューの提案を行います。200種類以上のトレーニングメニューが用意されています。" },
  { q: "FURDI銀座店は予約が必要ですか？", a: "いいえ、予約不要で好きな時間に通えます。サーキット型のトレーニングなので、自分のペースで取り組めます。" },
  { q: "FURDI銀座店は男性も利用できますか？", a: "いいえ、FURDIは女性専用のフィットネスジムです。女性だけの空間で安心してトレーニングできます。" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">FURDI 銀座店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">FURDI 銀座店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/FURDI+ファディー+銀座店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FURDI銀座店は、銀座駅から徒歩3分という抜群のアクセスを誇る女性専用AIフィットネスジムです。洗練された銀座エリアで、上質な空間でトレーニングしたい女性に支持されています。AIが一人ひとりに合わせたメニューを提案し、サーキット形式で効率的に全身を鍛えられます。月額7,678円〜で通い放題、予約不要なので、ランチタイムや仕事帰りなどスキマ時間を活用して通う方が多いです。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/FURDI%20%E3%83%95%E3%82%A1%E3%83%87%E3%82%A3%E3%83%BC%20%E9%8A%80%E5%BA%A7%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">AI指導というのが気になって入会しました。銀座店は大型モニターでフォームを確認しながらトレーニングできるので、一人でも正しいフォームで運動できます。月額7,678円〜で通い放題なのも魅力です。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">銀座のFURDIに通っています。月額7,678円〜で予約不要・通い放題は他のジムにはない魅力です。女性専用なので周りの目を気にせずトレーニングに集中できます。</p>
