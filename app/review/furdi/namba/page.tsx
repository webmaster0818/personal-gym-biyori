      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FURDIなんば店は、なんば駅から徒歩5分の女性専用AIフィットネスジムです。大阪ミナミの繁華街エリアで、ショッピングや食事のついでに通う女性も多い人気店舗です。AIが一人ひとりの体力レベルを分析し、最適なサーキットメニューを提案してくれるため、運動に自信がない方でも無理なく始められます。月額7,678円〜で通い放題、予約不要の手軽さが、なんばエリアの女性たちに支持されています。
          </p>
