...
export const metadata: Metadata = {
  title: "FURDI 池袋店の口コミ・評判",
  description:
    "FURDI（ファディー）池袋店の口コミ・評判を紹介。AI指導・女性専用サーキット型フィットネスの基本情報から利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "FURDI（ファディー）池袋店" },
...
const faqItems = [
  { q: "FURDI池袋店の月額料金はいくらですか？", a: "FURDI池袋店は月額7,678円〜で通い放題です。プランにより異なりますので、最新の料金は公式サイトでご確認ください。" },
  { q: "FURDI池袋店はAI指導ですか？", a: "はい、大型モニターにAIトレーナーが表示され、フォームの指導やメニューの提案を行います。200種類以上のトレーニングメニューが用意されています。" },
  { q: "FURDI池袋店は予約が必要ですか？", a: "いいえ、予約不要で好きな時間に通えます。サーキット型のトレーニングなので、自分のペースで取り組めます。" },
  { q: "FURDI池袋店は男性も利用できますか？", a: "いいえ、FURDIは女性専用のフィットネスジムです。女性だけの空間で安心してトレーニングできます。" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">FURDI 池袋店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">FURDI 池袋店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/FURDI+ファディー+池袋店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FURDI池袋店は、池袋駅から徒歩5分の好立地にある女性専用AIフィットネスジムです。駅周辺の商業施設が充実する池袋エリアで、買い物や仕事帰りに立ち寄る女性から人気を集めています。AIトレーナーが個別にメニューを提案し、正しいフォームを画面で確認しながらトレーニングできるため、運動経験が少ない方でも安心。月額7,678円〜で通い放題、予約不要という気軽さも魅力です。
          </p>
