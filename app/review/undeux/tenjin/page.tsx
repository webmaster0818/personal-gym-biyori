...
export const metadata: Metadata = {
  title: "UNDEUX SUPERBODY 天神店の口コミ・評判",
  description:
    "UNDEUX SUPERBODY 天神店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "UNDEUX SUPERBODY 天神店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "UNDEUX SUPERBODY天神店の料金はいくらですか？", a: "UNDEUX SUPERBODY天神店の料金は、2ヶ月集中コースで215,600円（税込）〜が目安です。入会金は33,000円（税込）です。月額制プランも用意されています。最新の料金は公式サイトでご確認ください。" },
  { q: "UNDEUX SUPERBODY天神店は女性専用ですか？", a: "はい、UNDEUX SUPERBODYは女性専用のボディメイクジムです。女性専用の空間で安心してトレーニングに集中できます。" },
  { q: "UNDEUX SUPERBODY天神店は食事管理もありますか？", a: "はい、パーソナルトレーニングに加えて食事宅配サービスが付いたプランがあります。忙しい方でも食事管理を無理なく続けられます。" },
  { q: "UNDEUX SUPERBODY天神店のアクセスは？", a: "天神駅 徒歩5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              UNDEUX SUPERBODY 天神店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/UNDEUX+SUPERBODY+天神店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            UNDEUX SUPERBODY天神店は、天神駅から徒歩5分の女性専用パーソナルジムです。パーソナルトレーニングと食事宅配サービスを組み合わせたプログラムが特徴です。天神エリアの利用者から、仕事帰りにも通いやすいと好評です。
          </p>
