...
export const metadata: Metadata = {
  title: "UNDEUX SUPERBODY 難波店の口コミ・評判",
  description:
    "UNDEUX SUPERBODY 難波店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "UNDEUX SUPERBODY 難波店" },
  { label: "住所", value: "大阪府大阪市中央区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "なんば駅 徒歩約5分" },
  { label: "営業時間", value: "8:00〜22:00（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "UNDEUX SUPERBODY難波店の料金はいくらですか？", a: "UNDEUX SUPERBODY難波店の料金は、2ヶ月集中コースで215,600円（税込）〜が目安です。入会金は33,000円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "UNDEUX SUPERBODY難波店の営業時間は？", a: "8:00〜22:00です。最新情報は公式サイトでご確認ください。" },
  { q: "UNDEUX SUPERBODY難波店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。" },
  { q: "UNDEUX SUPERBODY難波店のアクセスは？", a: "なんば駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  ...
  { name: "UNDEUX SUPERBODY 神戸店", href: "/review/undeux/kobe/" },
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="難波店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">UNDEUX SUPERBODY 難波店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">UNDEUX SUPERBODY 難波店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/UNDEUX+SUPERBODY+難波店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2>
          <p className="text-gray-700 leading-relaxed">UNDEUX SUPERBODY難波店は、なんば駅近くにある女性専用パーソナルジムです。関西エリアで本格的な女性向けボディメイクができると人気の店舗です。宅配食サービスと連携した食事管理と、女性の体に特化したトレーニングプログラムが好評。おしゃれな空間で楽しみながらトレーニングを続けられます。</p>
