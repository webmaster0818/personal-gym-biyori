...
const faqItems = [
  ...
  { q: "UNDEUX SUPERBODY池袋店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              UNDEUX SUPERBODY 池袋店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/UNDEUX+SUPERBODY+池袋店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            UNDEUX SUPERBODY池袋店は、池袋駅から徒歩圏内にある女性専用パーソナルジムです。パーソナルトレーニングと食事宅配サービスを組み合わせた独自のプログラムが特徴で、忙しい女性でも無理なくダイエットに取り組める環境が整っています。池袋エリアで働くOLや近隣に住む主婦層からの支持が高く、清潔感のある空間でリラックスしてトレーニングできると好評です。
          </p>
