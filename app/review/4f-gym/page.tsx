    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <figure className="mt-4 mb-2 overflow-hidden rounded-xl border border-gray-200">
          <img src="/brand-ss/4f-gym.jpg" alt="4Fのパーソナルジム（用賀）の公式サイト(スクリーンショット)" className="w-full h-auto" loading="lazy" />
        </figure>
        <p className="text-xs text-gray-400 mb-6">4Fのパーソナルジム（用賀） 公式サイトのスクリーンショット(2026年9月16日取得)。最新の料金・キャンペーンは公式サイトをご確認ください。</p>
        ...
        <nav className="mb-10 rounded-xl border border-gray-200 bg-gray-50 p-5">
          ...
          <ol className="space-y-1.5 text-sm list-decimal pl-5">
            ...
            <li><a href="#s2" className="text-teal-600 hover:underline">4Fのパーソナルジムの基本情報</a></li>
            <li><a href="#s3" className="text-teal-600 hover:underline">4Fのパーソナルジムの3つの強み</a></li>
            <li><a href="#s4" className="text-teal-600 hover:underline">4Fのパーソナルジムのメリット・デメリット</a></li>
            <li><a href="#s5" className="text-teal-600 hover:underline">4Fのパーソナルジムの料金</a></li>
            <li><a href="#s6" className="text-teal-600 hover:underline">4Fのパーソナルジムの口コミ概要</a></li>
            <li><a href="#s7" className="text-teal-600 hover:underline">4Fのパーソナルジムのよくある質問</a></li>
            <li><a href="#s8" className="text-teal-600 hover:underline">4Fのパーソナルジムが気になった方へ</a></li>
        ...
        <section className="mb-12">
          <h2 id="s2" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムの基本情報</h2>
        ...
        <section className="mb-12">
          <h2 id="s3" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムの3つの強み</h2>
        ...
        <section className="mb-12">
          <h2 id="s4" className="text-xl font-bold mb-6 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムのメリット・デメリット</h2>
        ...
        <section className="mb-12">
          <h2 id="s5" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムの料金</h2>
        ...
        <section className="mb-12">
          <h2 id="s6" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムの口コミ概要</h2>
      ...
      <GymCta slug="4f-gym" name="4Fのパーソナルジム" />
        ...
        <section className="mb-12">
          <h2 id="s7" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">4Fのパーソナルジムのよくある質問</h2>
        ...
        <section className="bg-teal-500 text-white rounded-xl p-8 text-center mb-10">
          <h2 id="s8" className="text-xl font-bold mb-3">4Fのパーソナルジムが気になった方へ</h2>
