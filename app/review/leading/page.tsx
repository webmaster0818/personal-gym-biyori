...
export default function LeadingReview() {
  return (
    <>
      ...
      <ReviewSummary gymName="LEADING" />
      <GymCta slug="leading" name="LEADING" variant="top" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <figure className="mt-4 mb-2 overflow-hidden rounded-xl border border-gray-200">
          <img src="/brand-ss/leading.jpg" alt="LEADINGの公式サイト(スクリーンショット)" className="w-full h-auto" loading="lazy" />
        </figure>
        <p className="text-xs text-gray-400 mb-6">LEADING 公式サイトのスクリーンショット(2026年9月16日取得)。最新の料金・キャンペーンは公式サイトをご確認ください。</p>
        ...
        <nav className="mb-10 rounded-xl border border-gray-200 bg-gray-50 p-5">
          ...
          <ol className="space-y-1.5 text-sm list-decimal pl-5">
            ...
            <li><a href="#s2" className="text-teal-600 hover:underline">LEADINGの基本情報</a></li>
            <li><a href="#s3" className="text-teal-600 hover:underline">LEADINGの3つの強み</a></li>
            <li><a href="#s4" className="text-teal-600 hover:underline">LEADINGのメリット・デメリット</a></li>
            <li><a href="#s5" className="text-teal-600 hover:underline">LEADINGの料金</a></li>
            <li><a href="#s6" className="text-teal-600 hover:underline">LEADINGの口コミ概要</a></li>
            <li><a href="#s7" className="text-teal-600 hover:underline">LEADINGのよくある質問</a></li>
            <li><a href="#s8" className="text-teal-600 hover:underline">LEADINGが気になった方へ</a></li>
