        ...
        <section className="mb-10">
          <div className="bg-teal-50 rounded-lg p-6 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/review/beyond/" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">BEYONDの総合レビューを見る</Link>
              <a href="https://beyond-gym.com/" target="_blank" rel="noopener noreferrer" className="inline-block border border-teal-600 text-teal-600 px-6 py-3 rounded-lg hover:bg-teal-50 transition-colors">BEYOND公式サイト</a>
            </div>
          </div>
        </section>
        <section className="mb-10">
