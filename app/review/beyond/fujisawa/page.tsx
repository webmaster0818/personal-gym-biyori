...
export const metadata: Metadata = {
  title: "BEYOND 藤沢店の口コミ・評判",
  description:
    "BEYOND 藤沢店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "BEYOND 藤沢店" },
  { label: "住所", value: "神奈川県藤沢市藤沢（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "JR藤沢駅 徒歩約5分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "BEYOND藤沢店の料金はいくらですか？", a: "回数券制で、STANDARD 10プラン（10回）が96,800円（税込）が目安です。入会金は無料です。最新の料金は公式サイトでご確認ください。" },
  { q: "BEYOND藤沢店の営業時間は？", a: "10:00〜22:00です。最新情報は公式サイトでご確認ください。" },
  { q: "BEYOND藤沢店のトレーナーの特徴は？", a: "ボディメイクコンテストの入賞経験者や有資格者のトレーナーが在籍しています。無理のない食事指導とトレーニングが特徴です。" },
  { q: "BEYOND藤沢店は入会金がかかりますか？", a: "いいえ、BEYONDは全店舗入会金無料です。コース料金のみでパーソナルトレーニングを始められます。" },
];
...
const relatedStores = [
  ...
  { name: "BEYOND 横浜元町店", href: "/review/beyond/yokohama-motomachi/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              BEYOND 藤沢店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/BEYOND+藤沢店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            BEYOND藤沢店は藤沢駅から徒歩5分に位置する店舗です。湘南エリアで本格的なパーソナルトレーニングを受けたい方に人気があります。海沿いのリラックスした雰囲気の中、ボディメイクに取り組む利用者が多いです。トレーナーの丁寧な指導と、無理のない食事アドバイスが口コミで好評です。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/BEYOND%20%E8%97%A4%E6%B2%A2%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「入会金がかからないのが決め手でした。回数券制なので月額の縛りがなく、忙しい月は回数を減らせるのが藤沢で働く自分には合っています。」</p>
              <p className="text-xs text-gray-400">-- 利用歴5ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「糖質制限がきつすぎないのが良かったです。藤沢で外食が多い生活でも無理なく続けられる食事プランを提案してもらえました。2ヶ月で体脂肪率が4%落ちました。」</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「店内がとてもきれいで、更衣室やシャワールームも清潔。藤沢駅からも近く通いやすいです。トレーナーさんの明るい雰囲気に毎回元気をもらっています。」</p>
              <p className="text-xs text-gray-400">-- 利用歴8ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「トレーナーさんが藤沢エリアの食事事情にも詳しくて、藤沢周辺のコンビニで買えるおすすめ食品まで教えてくれました。筋トレ初心者でしたが、フォームを丁寧に直してもらえて安心感がありました。」</p>
              <p className="text-xs text-gray-400">-- 入会1ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「大会出場経験のあるトレーナーが担当で、ボディメイクの知識がとにかく豊富。自分の骨格に合ったメニューを組んでくれるので、藤沢の他のジムとは結果の出方が違いました。」</p>
