...
export const metadata: Metadata = {
  title: "BEYOND 福岡天神店の口コミ・評判",
  description:
    "BEYOND 福岡天神店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "BEYOND 福岡天神店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "BEYOND福岡天神店の料金はいくらですか？", a: "回数券制で、STANDARD 10プラン（10回）が96,800円（税込）が目安です。入会金は無料です。最新の料金は公式サイトでご確認ください。" },
  { q: "BEYOND福岡天神店の営業時間は？", a: "10:00〜22:00です。最新情報は公式サイトでご確認ください。" },
  { q: "BEYOND福岡天神店のトレーナーの特徴は？", a: "ボディメイクコンテストの入賞経験者や、有資格者のトレーナーが在籍しています。専門知識に基づいた本格的な指導が特徴です。" },
  { q: "BEYOND福岡天神店は入会金がかかりますか？", a: "いいえ、BEYONDは全店舗入会金無料です。コース料金のみでパーソナルトレーニングを始められます。" },
];
...
const relatedStores = [
  ...
  { name: "BEYOND 札幌店", href: "/review/beyond/sapporo/" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              BEYOND 福岡天神店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/BEYOND+福岡天神店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            BEYOND福岡天神店は、天神駅から徒歩圏内に位置する九州エリアの店舗です。ボディメイクコンテスト入賞経験を持つトレーナーが在籍し、福岡市内のビジネスパーソンを中心に利用されています。入会金無料・回数券制で始めやすく、天神エリアの好立地で仕事帰りに通いやすいと好評です。九州で本格的なパーソナルトレーニングを受けたい方に支持されています。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/BEYOND%20%E7%A6%8F%E5%B2%A1%E5%A4%A9%E7%A5%9E%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「トレーナーさんが福岡エリアの食事事情にも詳しくて、福岡周辺のコンビニで買えるおすすめ食品まで教えてくれました。筋トレ初心者でしたが、フォームを丁寧に直してもらえて安心感がありました。」</p>
              <p className="text-xs text-gray-400">-- 利用歴5ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「大会出場経験のあるトレーナーが担当で、ボディメイクの知識がとにかく豊富。自分の骨格に合ったメニューを組んでくれるので、福岡の他のジムとは結果の出方が違いました。」</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「入会金がかからないのが決め手でした。回数券制なので月額の縛りがなく、忙しい月は回数を減らせるのが福岡で働く自分には合っています。」</p>
              <p className="text-xs text-gray-400">-- 利用歴8ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「糖質制限がきつすぎないのが良かったです。福岡で外食が多い生活でも無理なく続けられる食事プランを提案してもらえました。2ヶ月で体脂肪率が4%落ちました。」</p>
              <p className="text-xs text-gray-400">-- 入会1ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「店内がとてもきれいで、更衣室やシャワールームも清潔。福岡駅からも近く通いやすいです。トレーナーさんの明るい雰囲気に毎回元気をもらっています。」</p>
