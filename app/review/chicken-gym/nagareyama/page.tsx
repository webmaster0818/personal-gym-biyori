...
export const metadata: Metadata = {
  ...
  description:
    "チキンジム 流山おおたかの森店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "チキンジム流山おおたかの森店の料金はいくらですか？", a: "月々6,800円〜（分割払い時の目安）です。入会金35,000円（税込）が別途かかります。最新の料金は公式サイトでご確認ください。" },
  { q: "チキンジム流山おおたかの森店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "チキンジム流山おおたかの森店へのアクセスは？", a: "流山おおたかの森駅から徒歩約3分です。つくばエクスプレスと東武アーバンパークラインの2路線が利用可能です。" },
  { q: "チキンジム流山おおたかの森店は駐車場がありますか？", a: "近隣に提携駐車場や商業施設の駐車場があります。車での来店も可能です。詳細は店舗に直接お問い合わせください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="流山おおたかの森店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        {/* ---------- H1 ---------- */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          チキンジム 流山おおたかの森店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              チキンジム 流山おおたかの森店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/チキンジム+流山おおたかの森店"
              target="_blank"
