...
export const metadata: Metadata = {
  ...
  description:
    "CALORIE TRADE JAPAN 名古屋瑞穂区店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "CALORIE TRADE JAPAN 名古屋瑞穂区店" },
  { label: "住所", value: "名古屋市瑞穂区瑞穂通8-19-6" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "CALORIE TRADE JAPAN 名古屋瑞穂区店の料金はいくらですか？", a: "コースや回数によって料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 名古屋瑞穂区店の営業時間は？", a: "営業時間は店舗により異なります。最新情報は公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 名古屋瑞穂区店ではどんなトレーニングができますか？", a: "ダイエットに特化したパーソナルトレーニングを提供しています。食事指導も含めた総合的なボディメイクプログラムが特徴です。" },
  { q: "CALORIE TRADE JAPAN 名古屋瑞穂区店は無料体験できますか？", a: "無料カウンセリングや体験トレーニングの有無は時期により異なります。最新情報は公式サイトでご確認ください。" },
];
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          CALORIE TRADE JAPAN 名古屋瑞穂区店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              CALORIE TRADE JAPAN 名古屋瑞穂区店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/CALORIE+TRADE+JAPAN+名古屋瑞穂区店"
              target="_blank"
