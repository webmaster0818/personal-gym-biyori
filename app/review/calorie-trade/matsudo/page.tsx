...
export const metadata: Metadata = {
  title: "CALORIE TRADE JAPAN 松戸八柱店の口コミ・評判",
  description:
    "CALORIE TRADE JAPAN 松戸八柱店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "CALORIE TRADE JAPAN 松戸八柱店" },
  { label: "住所", value: "松戸市松戸新田579-28" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "CALORIE TRADE JAPAN 松戸八柱店の料金はいくらですか？", a: "コースや回数によって料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 松戸八柱店の営業時間は？", a: "営業時間は店舗により異なります。最新情報は公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 松戸八柱店ではどんなトレーニングができますか？", a: "ダイエットに特化したパーソナルトレーニングを提供しています。食事指導も含めた総合的なボディメイクプログラムが特徴です。" },
  { q: "CALORIE TRADE JAPAN 松戸八柱店へのアクセスは？", a: "松戸市松戸新田に位置しています。詳しいアクセス方法は公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="松戸八柱店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          CALORIE TRADE JAPAN 松戸八柱店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              CALORIE TRADE JAPAN 松戸八柱店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/CALORIE+TRADE+JAPAN+松戸八柱店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            CALORIE TRADE JAPAN 松戸八柱店は、千葉県松戸市に位置するダイエット特化型パーソナルジムです。八柱エリアは千葉県北西部の住宅地で、ファミリー層や働く世代が多いエリアです。カロリー管理に基づいた食事指導と効率的なトレーニングメニューが特徴で、短期間での体型変化を目指す方に支持されています。完全個室のプライベート空間で周囲を気にせずトレーニングに集中できます。
          </p>
