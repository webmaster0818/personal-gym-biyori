...
export const metadata: Metadata = {
  title: "CALORIE TRADE JAPAN 一宮本町店の口コミ・評判",
  description:
    "CALORIE TRADE JAPAN 一宮本町店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "CALORIE TRADE JAPAN 一宮本町店" },
  { label: "住所", value: "一宮市本町4-14-1" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "CALORIE TRADE JAPAN 一宮本町店の料金はいくらですか？", a: "コースや回数によって料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 一宮本町店の営業時間は？", a: "営業時間は店舗により異なります。最新情報は公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 一宮本町店ではどんなトレーニングができますか？", a: "ダイエットに特化したパーソナルトレーニングを提供しています。食事指導も含めた総合的なボディメイクプログラムが特徴です。" },
  { q: "CALORIE TRADE JAPAN 一宮本町店は無料体験できますか？", a: "無料カウンセリングや体験トレーニングの有無は時期により異なります。最新情報は公式サイトでご確認ください。" },
];
...
const relatedStores = [
  ...
  { name: "CALORIE TRADE JAPAN 名古屋緑区店", href: "/review/calorie-trade/nagoya-midori/" },
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="一宮本町店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          CALORIE TRADE JAPAN 一宮本町店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              CALORIE TRADE JAPAN 一宮本町店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/CALORIE+TRADE+JAPAN+一宮本町店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/CALORIE%20TRADE%20JAPAN%20TRADE%20JAPAN%20%E4%B8%80%E5%AE%AE%E6%9C%AC%E7%94%BA%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">TRADE JAPAN 一宮本町のCALORIE TRADE JAPANに通っています。名古屋発のフランチャイズということで信頼感がありました。トレーナーさんの指導が的確で効果を実感しています。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">カロリーコントロールに特化した食事指導が分かりやすいです。TRADE JAPAN 一宮本町店のトレーナーさんは明るくて、毎回楽しくトレーニングできます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            CALORIE TRADE JAPAN 一宮本町店は、愛知県一宮市の中心部・本町エリアに位置するパーソナルジムです。一宮駅からもアクセスしやすく、地元の方を中心に利用されています。ダイエットに特化したプログラムと丁寧な食事指導が特徴で、運動が苦手な方でも無理なく続けられると評判です。落ち着いた雰囲気の中でマンツーマン指導を受けられる点が好評です。
          </p>
