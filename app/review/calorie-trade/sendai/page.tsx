...
export const metadata: Metadata = {
  title: "CALORIE TRADE JAPAN 仙台泉区店の口コミ・評判",
  description:
    "CALORIE TRADE JAPAN 仙台泉区店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "CALORIE TRADE JAPAN 仙台泉区店" },
  { label: "住所", value: "仙台市泉区みずほ台3-1" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "CALORIE TRADE JAPAN 仙台泉区店の料金はいくらですか？", a: "コースや回数によって料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 仙台泉区店の営業時間は？", a: "営業時間は店舗により異なります。最新情報は公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 仙台泉区店は食事指導がありますか？", a: "はい、CALORIE TRADE JAPANではカロリー管理に基づいた食事指導を全店舗で提供しています。日々の食事内容をトレーナーに相談できます。" },
  { q: "CALORIE TRADE JAPAN 仙台泉区店は初心者でも大丈夫ですか？", a: "はい、運動初心者の方でも安心して通えます。個々の体力レベルに合わせたメニューを組んでもらえます。" },
];
...
const relatedStores = [
  ...
  { name: "CALORIE TRADE JAPAN 宜野湾店", href: "/review/calorie-trade/ginowan/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="仙台泉区店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          CALORIE TRADE JAPAN 仙台泉区店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              CALORIE TRADE JAPAN 仙台泉区店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/CALORIE+TRADE+JAPAN+仙台泉区店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/CALORIE%20TRADE%20JAPAN%20TRADE%20JAPAN%20%E4%BB%99%E5%8F%B0%E6%B3%89%E5%8C%BA%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">TRADE JAPAN 仙台泉区のCALORIE TRADE JAPANに通っています。名古屋発のフランチャイズということで信頼感がありました。トレーナーさんの指導が的確で効果を実感しています。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">カロリーコントロールに特化した食事指導が分かりやすいです。TRADE JAPAN 仙台泉区店のトレーナーさんは明るくて、毎回楽しくトレーニングできます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            CALORIE TRADE JAPAN 仙台泉区店は、仙台市泉区のみずほ台エリアに位置するパーソナルジムです。泉区は仙台市北部のベッドタウンとして発展しており、落ち着いた住宅環境の中でトレーニングに取り組めます。東北地方でダイエット特化型のパーソナルジムを探している方に選ばれており、カロリー管理に基づく食事指導とマンツーマンのトレーニングが好評です。寒冷地ならではの室内運動需要にも応えています。
          </p>
