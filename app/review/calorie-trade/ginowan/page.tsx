      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/CALORIE%20TRADE%20JAPAN%20TRADE%20JAPAN%20%E5%AE%9C%E9%87%8E%E6%B9%BE%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">カロリーコントロールに特化した食事指導が分かりやすいです。TRADE JAPAN 宜野湾店のトレーナーさんは明るくて、毎回楽しくトレーニングできます。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">TRADE JAPAN 宜野湾のCALORIE TRADE JAPANに通っています。名古屋発のフランチャイズということで信頼感がありました。トレーナーさんの指導が的確で効果を実感しています。</p>
