...
export const metadata: Metadata = {
  title: "CALORIE TRADE JAPAN 名古屋緑区店の口コミ・評判",
  description:
    "CALORIE TRADE JAPAN 名古屋緑区店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "CALORIE TRADE JAPAN 名古屋緑区店" },
  { label: "住所", value: "名古屋市緑区大将ヶ根2-1043" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "CALORIE TRADE JAPAN 名古屋緑区店の料金はいくらですか？", a: "コースや回数によって料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 名古屋緑区店の営業時間は？", a: "営業時間は店舗により異なります。最新情報は公式サイトでご確認ください。" },
  { q: "CALORIE TRADE JAPAN 名古屋緑区店ではどんなトレーニングができますか？", a: "ダイエットに特化したパーソナルトレーニングを提供しています。食事指導も含めた総合的なボディメイクプログラムが特徴です。" },
  { q: "CALORIE TRADE JAPAN 名古屋緑区店は駐車場がありますか？", a: "駐車場の有無は公式サイトでご確認ください。緑区エリアは車でのアクセスが便利な立地です。" },
];
...
const relatedStores = [
  ...
  { name: "CALORIE TRADE JAPAN 一宮本町店", href: "/review/calorie-trade/ichinomiya/" },
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="名古屋緑区店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          CALORIE TRADE JAPAN 名古屋緑区店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              CALORIE TRADE JAPAN 名古屋緑区店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/CALORIE+TRADE+JAPAN+名古屋緑区店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/CALORIE%20TRADE%20JAPAN%20TRADE%20JAPAN%20%E5%90%8D%E5%8F%A4%E5%B1%8B%E7%B7%91%E5%8C%BA%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">TRADE JAPAN 名古屋緑区のCALORIE TRADE JAPANに通っています。名古屋発のフランチャイズということで信頼感がありました。トレーナーさんの指導が的確で効果を実感しています。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">カロリーコントロールに特化した食事指導が分かりやすいです。TRADE JAPAN 名古屋緑区店のトレーナーさんは明るくて、毎回楽しくトレーニングできます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            CALORIE TRADE JAPAN 名古屋緑区店は、名古屋市緑区の大将ヶ根エリアに位置するパーソナルジムです。緑区は名古屋市内でもファミリー層が多い住宅地で、子育て世代の利用者も見られます。カロリーに着目した科学的な食事指導とトレーニングの組み合わせで、無理のないダイエットを実現できると評判です。車でのアクセスも良く、郊外型ならではの落ち着いた環境でトレーニングに集中できます。
          </p>
