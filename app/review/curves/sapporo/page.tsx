...
export const metadata: Metadata = {
  title: "カーブス 札幌店の口コミ・評判",
  description:
    "カーブス 札幌店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "カーブス 札幌店" },
...
const faqItems = [
  { q: "カーブス札幌店は女性専用ですか？", a: "はい、カーブスは全店舗女性専用のフィットネスクラブです。男性会員・男性スタッフはおりませんので、安心してご利用いただけます。" },
  { q: "カーブス札幌店の料金はいくらですか？", a: "月額6,820円〜（税込）です。プランによって料金が異なりますので、最新の料金は公式サイトでご確認ください。" },
...
const relatedStores = [
  { name: "カーブス 福岡店", href: "/review/curves/fukuoka/" },
  { name: "カーブス 新宿店", href: "/review/curves/shinjuku/" },
  { name: "カーブス 梅田店", href: "/review/curves/umeda/" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">カーブス 札幌店の口コミ・評判</h1>
        ...
        <div className="mb-10 text-center">
          <Link href="/review/curves/" className="inline-block bg-teal-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-teal-700 transition-colors text-sm">総合レビューを見る</Link>
        </div>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2>
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">カーブス 札幌店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/カーブス+札幌" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            カーブス札幌店は、札幌駅から徒歩5分の女性専用フィットネスです。北海道の寒い冬でも室内で快適に運動できるため、冬場の運動不足解消に利用する方が多いのが特徴です。30分のサーキットトレーニングは予約不要で、雪の日でも駅近なので通いやすいと好評です。コーチが親身になってサポートしてくれるので、運動が苦手な方や久しぶりに体を動かす方も安心して始められます。会員同士の仲も良く、通うことが楽しみになったという声が寄せられています。
          </p>
