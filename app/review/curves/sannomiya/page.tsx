...
export const metadata: Metadata = {
  title: "カーブス 三宮店の口コミ・評判",
  description:
    "カーブス 三宮店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "カーブス 三宮店" },
...
const faqItems = [
  { q: "カーブス三宮店は女性専用ですか？", a: "はい、カーブスは全店舗女性専用のフィットネスクラブです。男性会員・男性スタッフはおりませんので、安心してご利用いただけます。" },
  { q: "カーブス三宮店の料金はいくらですか？", a: "月額6,820円〜（税込）です。プランによって料金が異なりますので、最新の料金は公式サイトでご確認ください。" },
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">カーブス 三宮店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">カーブス 三宮店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/カーブス+三宮" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
