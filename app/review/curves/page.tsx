...
export const metadata: Metadata = {
  ...
  description:
    "カーブス（Curves）の口コミ・評判を徹底解説。女性専用30分フィットネス、全国2000店舗以上のメリット・デメリットまで網羅。",
};
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <p className="text-gray-700 leading-relaxed mb-10">
          カーブス（Curves）は全国2,000店舗以上を展開する<span className="font-bold bg-yellow-100 px-0.5">女性専用</span>30分フィットネスです。<span className="font-bold bg-yellow-100 px-0.5">予約不要</span>・<span className="font-bold bg-yellow-100 px-0.5">通い放題</span>という手軽さが魅力。有酸素運動、筋力運動、柔軟運動を組み合わせた独自プログラムで効率的にトレーニングできます。本記事では、カーブスのメリット・デメリット、口コミ傾向を詳しく解説します。
        </p>
