...
export const metadata: Metadata = {
  title: "カーブス 池袋店の口コミ・評判",
  description:
    "カーブス 池袋店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "カーブス 池袋店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "カーブス池袋店は女性専用ですか？", a: "はい、カーブスは全店舗女性専用のフィットネスクラブです。男性会員・男性スタッフはおりませんので、安心してご利用いただけます。" },
  { q: "カーブス池袋店の料金はいくらですか？", a: "月額6,820円〜（税込）です。プランによって料金が異なりますので、最新の料金は公式サイトでご確認ください。" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              カーブス 池袋店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/カーブス+池袋"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            カーブス池袋店は、池袋駅から徒歩5分の好立地にある女性専用フィットネスです。1回30分のサーキットトレーニングが予約不要で利用でき、仕事帰りや買い物のついでに通う方が多く見られます。スタッフの対応が親切で初心者でも安心して始められると好評です。年齢層は幅広く、運動習慣のなかった方がカーブスをきっかけに健康的な生活を送れるようになったという声が寄せられています。
          </p>
