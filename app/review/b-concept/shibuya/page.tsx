...
export const metadata: Metadata = {
  title: "ビーコンセプト 渋谷店の口コミ・評判",
  description:
    "ビーコンセプト 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ビーコンセプト 渋谷店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ビーコンセプト渋谷店の料金はいくらですか？", a: "ビーコンセプト渋谷店の料金は、2ヶ月コースで199,650円（税込）〜が目安です。入会金は38,500円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "ビーコンセプト渋谷店の営業時間は？", a: "7:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "ビーコンセプト渋谷店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト渋谷店のアクセスは？", a: "JR渋谷駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ビーコンセプト 渋谷店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ビーコンセプト+渋谷店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ビーコンセプト渋谷店は、渋谷駅近くに位置する女性専用パーソナルジムです。下半身太りや脚のラインに悩む女性に特化したトレーニングプログラムが特徴です。完全個室で人目を気にせずトレーニングでき、アフターフォローの充実度を評価する口コミが多いです。
          </p>
