...
export const metadata: Metadata = {
  ...
  title: "ビーコンセプト 練馬店の口コミ・評判",
  description:
    "ビーコンセプト 練馬店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "ビーコンセプト 練馬店" },
  { label: "住所", value: "東京都練馬区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "練馬駅 徒歩1分" },
  { label: "営業時間", value: "7:00〜23:00（※最新情報は公式サイトでご確認ください）" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "ビーコンセプト練馬店の料金はいくらですか？", a: "ビーコンセプト練馬店の料金は、2ヶ月コースで199,650円（税込）〜が目安です。入会金は38,500円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "ビーコンセプト練馬店の営業時間は？", a: "7:00〜23:00です。※最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト練馬店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト練馬店のアクセスは？", a: "練馬駅 徒歩1分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "ビーコンセプト", href: "/review/b-concept/" }, { name: "練馬店" }]} />
      <ReviewSummary gymName="練馬店" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">ビーコンセプト 練馬店の口コミ・評判</h1>
        ...
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2><div className="bg-gray-100 rounded-lg p-8 text-center"><p className="text-gray-600 mb-4">ビーコンセプト 練馬店の所在地をGoogleマップで確認できます。</p><a href="https://www.google.com/maps/search/ビーコンセプト+練馬店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a></div></section>
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2><p className="text-gray-700 leading-relaxed">ビーコンセプト練馬店は、練馬駅から徒歩1分という駅近の女性専用パーソナルジムです。練馬区エリアで脚痩せ・下半身ダイエットに特化したプログラムが人気で、駅からのアクセスの良さが好評です。</p><p className="text-xs text-gray-500 mt-4 bg-gray-50 rounded p-3">※口コミはGoogleマップの投稿を参考に要約・再構成したものです。個人の感想であり、効果を保証するものではありません。</p></section>
