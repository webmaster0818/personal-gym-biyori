...
export const metadata: Metadata = {
  title: "ビーコンセプト 横浜店の口コミ・評判",
  description:
    "ビーコンセプト 横浜店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ビーコンセプト 横浜店" },
  { label: "住所", value: "神奈川県横浜市西区（※最新情報は公式サイトでご確認ください）" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ビーコンセプト横浜店の料金はいくらですか？", a: "ビーコンセプト横浜店の料金は、2ヶ月コースで199,650円（税込）〜が目安です。入会金は38,500円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "ビーコンセプト横浜店の営業時間は？", a: "7:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "ビーコンセプト横浜店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト横浜店のアクセスは？", a: "JR横浜駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ビーコンセプト 横浜店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ビーコンセプト+横浜店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ビーコンセプト横浜店は、横浜駅から徒歩圏内にある女性専用パーソナルジムです。脚痩せ・下半身ダイエットに特化しており、神奈川エリアの女性から支持されています。完全個室のプライベート空間で、人目を気にせずトレーニングに集中できると好評です。
          </p>
        ...
        <section className="mb-10">
          <div className="bg-teal-50 rounded-lg p-6 text-center space-y-4">
            <p className="font-bold text-gray-800">
              ビーコンセプトの詳しい口コミ・料金情報はこちら
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link
                href="/review/b-concept/"
                className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors"
              >
                ビーコンセプトの総合レビューを見る
              </Link>
              <a
                href="https://b-concept.tokyo/"
                target="_blank"
                rel="noopener noreferrer"
