...
export const metadata: Metadata = {
  title: "ビーコンセプト 池袋店の口コミ・評判",
  description:
    "ビーコンセプト 池袋店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ビーコンセプト 池袋店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ビーコンセプト池袋店の料金はいくらですか？", a: "ビーコンセプト池袋店の料金は、2ヶ月コースで199,650円（税込）〜が目安です。入会金は38,500円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "ビーコンセプト池袋店の営業時間は？", a: "7:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "ビーコンセプト池袋店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト池袋店のアクセスは？", a: "JR池袋駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ビーコンセプト 池袋店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ビーコンセプト+池袋店"
              target="_blank"
