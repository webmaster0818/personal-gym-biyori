...
export const metadata: Metadata = {
  title: "ビーコンセプト 大宮店の口コミ・評判",
  description:
    "ビーコンセプト 大宮店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "ビーコンセプト 大宮店" },
...
const faqItems = [
  { q: "ビーコンセプト大宮店の料金はいくらですか？", a: "ビーコンセプト大宮店の料金は、2ヶ月コースで199,650円（税込）〜が目安です。入会金は38,500円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "ビーコンセプト大宮店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "ビーコンセプト大宮店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。" },
  { q: "ビーコンセプト大宮店のアクセスは？", a: "大宮駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">ビーコンセプト 大宮店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">ビーコンセプト 大宮店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/ビーコンセプト+大宮店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
