...
export const metadata: Metadata = {
  title: "STUDIO KOMPAS 渋谷店の口コミ・評判",
  description:
    "STUDIO KOMPAS 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "STUDIO KOMPAS 渋谷店" },
...
const faqItems = [
  { q: "STUDIO KOMPAS渋谷店の料金はいくらですか？", a: "コースにより異なります。最新の料金は公式サイトでご確認ください。" },
  { q: "STUDIO KOMPAS渋谷店の営業時間は？", a: "営業時間は公式サイトでご確認ください。" },
  { q: "STUDIO KOMPAS渋谷店は体験トレーニングを受けられますか？", a: "はい、体験トレーニングが用意されています。公式サイトから予約可能です。" },
  { q: "STUDIO KOMPAS渋谷店のアクセスは？", a: "渋谷駅から徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  { name: "リノユー 渋谷店", href: "/review/lino-u/shibuya/" },
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">STUDIO KOMPAS 渋谷店の口コミ・評判</h1>
        ...
        <div className="mb-10 text-center">
          <Link href="/review/studio-kompas/" className="inline-block bg-teal-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-teal-700 transition-colors text-sm">総合レビューを見る</Link>
        </div>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2>
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">STUDIO KOMPAS 渋谷店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/STUDIO+KOMPAS+渋谷店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="bg-teal-50 rounded-lg p-6 text-center space-y-4">
            <p className="font-bold text-gray-800">STUDIO KOMPASの詳しい口コミ・料金情報はこちら</p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Link href="/review/studio-kompas/" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">STUDIO KOMPASの総合レビューを見る</Link>
            </div>
          </div>
        </section>

        <section className="mb-10">
          <h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">渋谷エリアの他のジム</h2>
