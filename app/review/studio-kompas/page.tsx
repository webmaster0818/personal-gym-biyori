...
export default function StudioKompasReview() {
  return (
    <>
      ...
      <GymCta slug="studio-kompas" name="STUDIO KOMPAS" variant="top" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <nav className="mb-10 rounded-xl border border-gray-200 bg-gray-50 p-5">
          ...
          <ol className="space-y-1.5 text-sm list-decimal pl-5">
            ...
            <li><a href="#s2" className="text-teal-600 hover:underline">STUDIO KOMPASの基本情報</a></li>
            <li><a href="#s3" className="text-teal-600 hover:underline">STUDIO KOMPASの3つの強み</a></li>
            <li><a href="#s4" className="text-teal-600 hover:underline">STUDIO KOMPASのメリット・デメリット</a></li>
            <li><a href="#s5" className="text-teal-600 hover:underline">STUDIO KOMPASの料金</a></li>
            <li><a href="#s6" className="text-teal-600 hover:underline">STUDIO KOMPASの口コミ概要</a></li>
            <li><a href="#s7" className="text-teal-600 hover:underline">STUDIO KOMPASのよくある質問</a></li>
            <li><a href="#s8" className="text-teal-600 hover:underline">STUDIO KOMPASが気になった方へ</a></li>
        ...
        <section className="mb-12">
          <h2 id="s2" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">STUDIO KOMPASの基本情報</h2>
        ...
        <section className="mb-12">
          <h2 id="s3" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">STUDIO KOMPASの3つの強み</h2>
        ...
        <section className="mb-12">
          <h2 id="s4" className="text-xl font-bold mb-6 pb-2 border-b-2 border-teal-500">STUDIO KOMPASのメリット・デメリット</h2>
        ...
        <section className="mb-12">
          <h2 id="s5" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">STUDIO KOMPASの料金</h2>
        ...
        <section className="mb-12">
          <h2 id="s6" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">STUDIO KOMPASの口コミ概要</h2>
      ...
      <GymCta slug="studio-kompas" name="STUDIO KOMPAS" />


        <section className="mb-12">
          <h2 id="s7" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">STUDIO KOMPASのよくある質問</h2>
        ...
        <section className="bg-teal-500 text-white rounded-xl p-8 text-center mb-10">
          <h2 id="s8" className="text-xl font-bold mb-3">STUDIO KOMPASが気になった方へ</h2>
