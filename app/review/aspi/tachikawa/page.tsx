...
export const metadata: Metadata = {
  title: "ASPI 立川店の口コミ・評判",
  description:
    "ASPI 立川店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 立川店" },
  { label: "住所", value: "東京都立川市立川（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "立川駅 徒歩5分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI立川店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI立川店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI立川店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI立川店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "ASPI 吉祥寺店", href: "/review/aspi/kichijoji/" },
  { name: "ASPI 町田店", href: "/review/aspi/machida/" },
  { name: "ASPI 新宿代々木店", href: "/review/aspi/shinjuku/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 立川店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+立川店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI立川店は立川駅から徒歩5分のアクセスしやすい店舗です。全トレーナーが有資格者で、多摩エリアで高品質なパーソナルトレーニングを提供しています。月額7,600円からの手頃な料金設定で、長期的な通いやすさが魅力です。オンライン食事指導やストレッチ指導も充実しており、総合的なサポートを受けられます。
          </p>
