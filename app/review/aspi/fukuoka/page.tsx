...
export const metadata: Metadata = {
  title: "ASPI 福岡天神店の口コミ・評判",
  description:
    "ASPI 福岡天神店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI福岡天神店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI福岡天神店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI福岡天神店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI福岡天神店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
const relatedStores = [
  ...
  { name: "ASPI 札幌店", href: "/review/aspi/sapporo/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 福岡天神店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+福岡天神店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI福岡天神店は天神駅から徒歩5分の立地にある店舗です。有資格トレーナーによる専門的な指導が受けられ、九州エリアで高品質なパーソナルトレーニングを提供しています。月額7,600円からの手頃な料金設定で、食事指導やストレッチ指導も含まれた包括的なサポートが魅力です。福岡で本格的なボディメイクを始めたい方に人気です。
          </p>
