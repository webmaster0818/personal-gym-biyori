...
export const metadata: Metadata = {
  title: "ASPI 二子玉川店の口コミ・評判",
  description:
    "ASPI 二子玉川店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 二子玉川店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI二子玉川店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI二子玉川店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI二子玉川店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI二子玉川店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "ASPI 自由が丘店", href: "/review/aspi/jiyugaoka/" },
  { name: "ASPI 中目黒店", href: "/review/aspi/nakameguro/" },
  { name: "ASPI 川崎店", href: "/review/aspi/kawasaki/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 二子玉川店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+二子玉川店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI二子玉川店は二子玉川駅から徒歩3分の便利な立地にある店舗です。全トレーナーが資格を保有しており、専門的な知識に基づいた指導が受けられます。月額7,600円からの手頃な料金と、オンライン食事指導の充実したサポートが魅力です。世田谷エリアで質の高いパーソナルトレーニングを探している方に人気の店舗です。
          </p>
