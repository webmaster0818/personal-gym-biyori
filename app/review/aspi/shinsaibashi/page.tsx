...
export const metadata: Metadata = {
  title: "ASPI 心斎橋店の口コミ・評判",
  description:
    "ASPI 心斎橋店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 心斎橋店" },
  { label: "住所", value: "大阪府大阪市心斎橋（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "心斎橋駅 徒歩3分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI心斎橋店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI心斎橋店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI心斎橋店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI心斎橋店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "ASPI 梅田店", href: "/review/aspi/umeda/" },
  { name: "ASPI 名古屋栄店", href: "/review/aspi/nagoya/" },
  { name: "ASPI 福岡天神店", href: "/review/aspi/fukuoka/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 心斎橋店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+心斎橋店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI心斎橋店は心斎橋駅から徒歩3分の好立地にある店舗です。全トレーナーが有資格者で、ミナミエリアで本格的なパーソナルトレーニングが受けられます。月額7,600円からの手頃な料金と、ストレッチ指導やオンライン食事指導も含まれた充実したプログラムが好評です。ショッピングのついでにも通いやすい立地が魅力です。
          </p>
