...
export const metadata: Metadata = {
  title: "ASPI 新宿代々木店の口コミ・評判",
  description:
    "ASPI 新宿代々木店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 新宿代々木店" },
  { label: "住所", value: "東京都渋谷区代々木（※最新情報は公式サイトでご確認ください）" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI新宿代々木店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI新宿代々木店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI新宿代々木店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI新宿代々木店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
const relatedStores = [
  ...
  { name: "ASPI 渋谷店", href: "/review/aspi/shibuya/" },
  { name: "ASPI 恵比寿東口店", href: "/review/aspi/ebisu/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 新宿代々木店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+新宿代々木店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI新宿代々木店は有資格トレーナーによる丁寧な指導が好評の店舗です。代々木駅から徒歩3分と通いやすく、月額7,600円からの手頃な料金で本格的なパーソナルトレーニングが受けられます。初心者にも分かりやすい指導が特徴で、運動経験がない方にも安心と評判です。オンライン食事指導との組み合わせで、効率的なボディメイクを実現できます。
          </p>
