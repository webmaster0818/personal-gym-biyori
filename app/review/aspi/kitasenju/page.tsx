...
export const metadata: Metadata = {
  title: "ASPI 北千住店の口コミ・評判",
  description:
    "ASPI 北千住店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 北千住店" },
  { label: "住所", value: "東京都足立区北千住（※最新情報は公式サイトでご確認ください）" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI北千住店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI北千住店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI北千住店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI北千住店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "ASPI 錦糸町店", href: "/review/aspi/kinshicho/" },
  { name: "ASPI 秋葉原店", href: "/review/aspi/akihabara/" },
  { name: "ASPI 池袋店", href: "/review/aspi/ikebukuro/" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 北千住店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+北千住店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI北千住店は北千住駅から徒歩5分の立地にある店舗です。有資格トレーナーによるパーソナルトレーニングが月額7,600円からの手頃な価格で受けられます。北千住エリアで質の高い指導を求める方に支持されています。オンライン食事指導にも対応しており、生活リズムに合わせた食事管理もサポートしてくれます。
          </p>
