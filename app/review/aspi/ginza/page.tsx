...
export const metadata: Metadata = {
  title: "ASPI 銀座店の口コミ・評判",
  description:
    "ASPI 銀座店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 銀座店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI銀座店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI銀座店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI銀座店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI銀座店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
...
const relatedStores = [
  ...
  { name: "ASPI 六本木店", href: "/review/aspi/roppongi/" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 銀座店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+銀座店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI銀座店は全トレーナーが有資格者という信頼性の高さが評価されている店舗です。月額7,600円からという手頃な価格帯で本格的なパーソナルトレーニングを受けられる点が好評です。銀座駅から徒歩3分の好立地で、仕事帰りやショッピングのついでに通いやすいと評判です。オンライン食事指導やストレッチ指導も含まれ、トータルでの体づくりをサポートしてくれます。
          </p>
