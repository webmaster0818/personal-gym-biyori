...
export const metadata: Metadata = {
  title: "ASPI 六本木店の口コミ・評判",
  description:
    "ASPI 六本木店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "ASPI 六本木店" },
  { label: "住所", value: "東京都港区六本木（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "六本木駅 徒歩3分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "ASPI六本木店のトレーナーは資格を持っていますか？", a: "はい、ASPIは全トレーナーが米国の高難度資格を保有しています。専門知識に基づいた質の高い指導が特徴です。" },
  { q: "ASPI六本木店の料金はいくらですか？", a: "月額7,600円（税込）から利用可能です。最新の料金プランは公式サイトでご確認ください。" },
  { q: "ASPI六本木店ではオンライン食事指導を受けられますか？", a: "はい、ASPIではオンラインでの食事指導に対応しています。トレーニングと合わせて食事面からもサポートを受けられます。" },
  { q: "ASPI六本木店ではストレッチ指導も受けられますか？", a: "はい、ASPIではトレーニングに加えてストレッチ指導も行っています。柔軟性の向上やケガの予防にも効果的です。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              ASPI 六本木店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/ASPI+六本木店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            ASPI六本木店は六本木駅から徒歩3分の好立地にある店舗です。全トレーナーが米国資格保有者で、専門的な知識に基づいたトレーニング指導が受けられます。月額7,600円からの手頃な料金で、忙しいビジネスパーソンにも通いやすいと好評です。食事指導やストレッチ指導も充実しており、トータルボディケアを実現できます。
          </p>
