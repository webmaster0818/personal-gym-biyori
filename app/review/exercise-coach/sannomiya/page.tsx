...
export const metadata: Metadata = {
  ...
  description:
    "エクササイズコーチ 三宮店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "エクササイズコーチ三宮店の料金はいくらですか？", a: "月額9,900円〜（月4回コース）が目安です。入会金19,800円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "エクササイズコーチ三宮店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "エクササイズコーチ三宮店のAIマシンとは？", a: "個人の筋力データに基づいてAIが最適な負荷を自動設定するマシンです。毎回のトレーニングで筋力の変化を測定し、常に最適な強度でトレーニングできます。" },
  { q: "エクササイズコーチ三宮店へのアクセスは？", a: "神戸三宮駅から徒歩3分です。三宮エリアの中心部に位置し、複数路線からアクセスできます。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              エクササイズコーチ 三宮店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/エクササイズコーチ+三宮店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/%E3%82%A8%E3%82%AF%E3%82%B5%E3%82%B5%E3%82%A4%E3%82%BA%E3%82%B3%E3%83%BC%E3%83%81%20%E4%B8%89%E5%AE%AE%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「1回たった20分で終わるので、三宮でのランチ休憩中にサッと通えます。短時間なのにAIマシンが限界まで追い込んでくれるので効果はしっかり感じます。忙しい人にぴったりです。」</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「マシンが自動で負荷を調整してくれるのが面白い。三宮でいくつかジムを試しましたが、テクノロジーを活用したトレーニングは新鮮でした。コーチもしっかりサポートしてくれます。」</p>
              <p className="text-xs text-gray-400">-- 利用歴6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「月4回1万円以下で通えるのが魅力。三宮のパーソナルジムの中では圧倒的にコスパが良いです。予約不要なので、空いた時間にふらっと行けるのも続けやすいポイントです。」</p>
              <p className="text-xs text-gray-400">-- 利用歴4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「20分で本当に効果があるのか半信半疑でしたが、三宮店に通い始めて2ヶ月で明らかに体が引き締まりました。AIが毎回最適な重量を設定してくれるので、無駄がないトレーニングだと実感しています。」</p>
              <p className="text-xs text-gray-400">-- 入会2ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「アメリカ発のメソッドということで興味を持ちました。三宮店のコーチが丁寧にマシンの使い方を教えてくれたので、初回から安心でした。短時間で終わるので運動嫌いでも続けられています。」</p>
