...
export const metadata: Metadata = {
  ...
  description:
    "エクササイズコーチ トキハわさだタウン店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "エクササイズコーチ トキハわさだタウン店" },
  { label: "住所", value: "大分県大分市（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "バスでのアクセスが便利" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "エクササイズコーチトキハわさだタウン店の料金はいくらですか？", a: "月額9,900円〜（月4回コース）が目安です。入会金19,800円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "エクササイズコーチトキハわさだタウン店の営業時間は？", a: "7:00〜23:00です。最新情報は公式サイトでご確認ください。" },
  { q: "エクササイズコーチトキハわさだタウン店のAIマシンとは？", a: "個人の筋力データに基づいてAIが最適な負荷を自動設定するマシンです。毎回のトレーニングで筋力の変化を測定し、常に最適な強度でトレーニングできます。" },
  { q: "エクササイズコーチトキハわさだタウン店へのアクセスは？", a: "トキハわさだタウン内にあり、バスでのアクセスが便利です。駐車場も完備しており、車での来店もしやすい環境です。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="トキハわさだタウン店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        {/* ---------- H1 ---------- */}
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">
          エクササイズコーチ トキハわさだタウン店の口コミ・評判
        </h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              エクササイズコーチ トキハわさだタウン店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/エクササイズコーチ+トキハわさだタウン店"
              target="_blank"
