...
export const metadata: Metadata = {
  title: "ACCEPT 新宿店の口コミ・評判",
  description:
    "ACCEPT 新宿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "ACCEPT 新宿店" },
...
const faqItems = [
  { q: "ACCEPT新宿店の料金はいくらですか？", a: "コースにより異なります。最新の料金は公式サイトでご確認ください。" },
  { q: "ACCEPT新宿店の営業時間は？", a: "営業時間は公式サイトでご確認ください。" },
  { q: "ACCEPT新宿店は体験トレーニングを受けられますか？", a: "はい、体験トレーニングが用意されています。公式サイトから予約可能です。" },
  { q: "ACCEPT新宿店のトレーナーの特徴は？", a: "経験豊富なトレーナーが在籍しており、個々の目標に合わせた指導を行っています。詳しくは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  { name: "ACCEPT 六本木店", href: "/review/accept/roppongi/" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">ACCEPT 新宿店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">ACCEPT 新宿店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/ACCEPT+パーソナルジム+新宿店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
