...
export const metadata: Metadata = {
  title: "Laststyle 新宿店の口コミ・評判",
  description:
    "Laststyle 新宿店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Laststyle 新宿店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Laststyle新宿店の料金はいくらですか？", a: "Laststyle新宿店の料金は、2ヶ月コースで176,000円（税込）〜が目安です。入会金は33,000円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "Laststyle新宿店の営業時間は？", a: "9:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "Laststyle新宿店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "Laststyle新宿店のアクセスは？", a: "JR新宿駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Laststyle 新宿店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Laststyle+新宿店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Laststyle新宿店は、新宿駅から徒歩圏内に位置するパーソナルジムです。完全個室でのマンツーマンレッスンが特徴で、ダイエットからボディメイクまで幅広いニーズに対応しています。トレーナーのコミュニケーション力が高く、楽しく通えると口コミで好評です。
          </p>
