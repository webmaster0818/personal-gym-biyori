...
export const metadata: Metadata = {
  title: "Laststyle 新宿2号店の口コミ・評判",
  description:
    "Laststyle 新宿2号店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "Laststyle 新宿2号店" },
...
const faqItems = [
  { q: "Laststyle新宿2号店の料金はいくらですか？", a: "Laststyle新宿2号店の料金は、2ヶ月コースで176,000円（税込）〜が目安です。入会金は33,000円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "Laststyle新宿2号店の営業時間は？", a: "9:00〜23:00です。※最新情報は公式サイトでご確認ください。" },
  { q: "Laststyle新宿2号店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。" },
  { q: "Laststyle新宿2号店のアクセスは？", a: "新宿駅から徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  ...
  { name: "Laststyle 渋谷店", href: "/review/laststyle/shibuya/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="新宿2号店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Laststyle 新宿2号店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Laststyle 新宿2号店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/Laststyle+新宿2号店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Laststyle新宿2号店は、新宿エリアの需要増加に伴い増設された2号店です。既存の新宿店と同様にリーズナブルな価格帯で質の高いパーソナルトレーニングが受けられます。新宿駅からアクセスが良く、遅い時間まで営業しているため、仕事帰りに通いやすいと好評です。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Laststyle%20%E6%96%B0%E5%AE%BF2%E5%8F%B7%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">ボクシングとパーソナルトレーニングの組み合わせが新鮮で、毎回のセッションが楽しみです。新宿2号店は駅から近く、仕事帰りに通いやすいです。ストレス発散にもなります。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">新宿2号のLaststyleは、ボクシングとパーソナルトレーニングを組み合わせた独自のプログラムが魅力です。筋トレだけだと飽きてしまう自分にはぴったりでした。</p>
