...
export const metadata: Metadata = {
  ...
  description:
    "Laststyle 町田店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Laststyle町田店の料金はいくらですか？", a: "Laststyle町田店の料金は、2ヶ月コースで176,000円（税込）〜が目安です。入会金は33,000円（税込）です。最新の料金は公式サイトでご確認ください。" },
  { q: "Laststyle町田店の営業時間は？", a: "9:00〜23:00です。※最新情報は公式サイトでご確認ください）" },
  { q: "Laststyle町田店は無料カウンセリングを受けられますか？", a: "はい、無料カウンセリング（体験）が用意されています。公式サイトから予約可能です。最新情報は公式サイトでご確認ください。" },
  { q: "Laststyle町田店のアクセスは？", a: "JR町田駅 徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Laststyle 町田店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Laststyle+町田店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Laststyle%20%E7%94%BA%E7%94%B0%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">町田のLaststyleは、ボクシングとパーソナルトレーニングを組み合わせた独自のプログラムが魅力です。筋トレだけだと飽きてしまう自分にはぴったりでした。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">ボクシングとパーソナルトレーニングの組み合わせが新鮮で、毎回のセッションが楽しみです。町田店は駅から近く、仕事帰りに通いやすいです。ストレス発散にもなります。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Laststyle町田店は、町田駅から徒歩圏内に位置するパーソナルジムです。郊外エリアでも質の高いパーソナルトレーニングが受けられると好評です。アットホームな雰囲気で、運動初心者でも通いやすい環境が整っていると口コミで評価されています。
          </p>
