...
export const metadata: Metadata = {
  title: "RAT 高槻店の口コミ・評判",
  description:
    "RAT 高槻店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "RAT 高槻店" },
  { label: "住所", value: "大阪府高槻市（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "高槻駅 徒歩3分" },
  { label: "営業時間", value: "9:00〜22:00" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "RAT高槻店の料金はいくらですか？", a: "2ヶ月148,000円〜のコースが用意されています。大手と比較してリーズナブルな料金で女性向けのパーソナルトレーニングが受けられます。最新の料金は公式サイトでご確認ください。" },
  { q: "RAT高槻店は完全個室ですか？", a: "はい、Ratは全室完全個室のパーソナルジムです。他の会員と会うことなく、プライベート空間でトレーニングできます。" },
  { q: "RAT高槻店は女性でも通いやすいですか？", a: "はい、Ratは女性専用に近いパーソナルジムです。完全個室でリーズナブルな料金設定なので、初めてのパーソナルジムとしても安心です。" },
  { q: "RAT高槻店のアクセスは？", a: "高槻駅から徒歩3分の好立地です。大阪方面・京都方面どちらからもアクセスしやすい場所にあります。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  { name: "RAT 神戸三宮元町店", href: "/review/rat/kobe-sannomiya/" },
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="高槻店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">RAT 高槻店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">RAT 高槻店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/RAT+パーソナルジム+高槻店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
