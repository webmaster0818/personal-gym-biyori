...
export const metadata: Metadata = {
  title: "RAT 北千住店の口コミ・評判",
  description:
    "RAT 北千住店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "RAT 北千住店" },
  { label: "住所", value: "東京都足立区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "北千住駅 徒歩5分" },
  { label: "営業時間", value: "9:00〜22:00" },
  { label: "電話番号", value: "公式サイト参照" },
];

const faqItems = [
  { q: "RAT北千住店の料金はいくらですか？", a: "2ヶ月148,000円〜のコースが用意されています。女性向けのリーズナブルな価格設定が特徴です。最新の料金は公式サイトでご確認ください。" },
  { q: "RAT北千住店は完全個室ですか？", a: "はい、Ratは全室完全個室のパーソナルジムです。周囲を気にせずトレーニングに集中できます。" },
  { q: "RAT北千住店は女性でも通いやすいですか？", a: "はい、Ratは女性向けのパーソナルジムとして設計されています。完全個室で人目を気にせず、リーズナブルな価格で本格的なトレーニングが受けられます。" },
  { q: "RAT北千住店のアクセスは？", a: "北千住駅から徒歩5分の好立地です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
const relatedStores = [
  ...
  { name: "RAT 中目黒店", href: "/review/rat/nakameguro/" },
  { name: "RAT 柏店", href: "/review/rat/kashiwa/" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">RAT 北千住店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">RAT 北千住店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/RAT+パーソナルジム+北千住店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            RAT北千住店は、北千住駅から徒歩5分のアクセス良好な立地にある女性向けパーソナルジムです。完全個室のプライベート空間で、人目を気にせずトレーニングできると好評です。リーズナブルな料金設定ながら、手ぶらで通える充実のレンタルサービスも整っており、仕事帰りに気軽に立ち寄れる点が多くの利用者から支持されています。
          </p>
