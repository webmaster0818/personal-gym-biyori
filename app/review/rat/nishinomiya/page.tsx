...
export const metadata: Metadata = {
  title: "RAT 西宮北口店の口コミ・評判",
  description:
    "RAT 西宮北口店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const faqItems = [
  { q: "RAT西宮北口店の料金はいくらですか？", a: "2ヶ月148,000円〜のコースが用意されています。大手パーソナルジムよりリーズナブルな料金で女性向けのトレーニングが受けられます。最新の料金は公式サイトでご確認ください。" },
  { q: "RAT西宮北口店は完全個室ですか？", a: "はい、Ratは全室完全個室のパーソナルジムです。周囲を気にせず集中してトレーニングに取り組めます。" },
  { q: "RAT西宮北口店は女性でも通いやすいですか？", a: "はい、Ratは女性をメインターゲットとしたパーソナルジムです。完全個室・リーズナブル・手ぶらOKで、女性が安心して通える環境です。" },
  { q: "RAT西宮北口店のアクセスは？", a: "西宮北口駅から徒歩5分の立地です。阪急神戸線沿線からアクセスしやすく便利です。詳しいアクセスは公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="西宮北口店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">RAT 西宮北口店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">RAT 西宮北口店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/RAT+パーソナルジム+西宮北口店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
