...
export const metadata: Metadata = {
  title: "FIT24 大宮店の口コミ・評判",
  description:
    "FIT24 大宮店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "FIT24 大宮店" },
  { label: "住所", value: "埼玉県さいたま市（※最新の住所は公式サイトでご確認ください）" },
...
const faqItems = [
  { q: "FIT24大宮店は24時間営業ですか？", a: "はい、FIT24は24時間営業のセルフ型フィットネスジムです。早朝や深夜など、お好きな時間にトレーニングが可能です。" },
  { q: "FIT24大宮店の料金はいくらですか？", a: "FIT24は月額3,980円〜のリーズナブルな料金設定です。プランにより料金が異なりますので、最新の料金は公式サイトでご確認ください。" },
  { q: "FIT24大宮店はどんなマシンがありますか？", a: "有酸素マシン、筋力トレーニングマシンなど多種多様なマシンが充実しています。初心者から上級者まで対応できる設備が整っています。" },
  { q: "FIT24大宮店は初心者でも利用できますか？", a: "はい、セルフ型ジムですが各マシンに使い方の説明があり、初心者の方でも安心して利用できます。" }
];
...
const relatedStores = [
  { name: "FIT24 池袋店", href: "/review/fit24/ikebukuro/" },
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">FIT24 大宮店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">FIT24 大宮店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/FIT24+大宮店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            FIT24大宮店は大宮駅から徒歩5分の24時間営業フィットネスジムです。月額3,980円〜という低価格で充実したマシン設備が利用できます。埼玉エリアで24時間利用可能なセルフ型フィットネスとして、仕事帰りや休日に自分のペースで通いたい方に支持されています。
          </p>
