...
export const metadata: Metadata = {
  ...
  description:
    "24/7ワークアウト 心斎橋店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const faqItems = [
  { q: "24/7ワークアウト心斎橋店の料金はいくらですか？", a: "2ヶ月コース（全16回）で月額33,000円〜の月額制プランです。入会金は無料です。最新の料金は公式サイトでご確認ください。" },
  { q: "24/7ワークアウト心斎橋店は完全個室ですか？", a: "はい、完全個室のマンツーマン指導です。他の利用者の目を気にせずトレーニングに集中できます。" },
  { q: "24/7ワークアウト心斎橋店の食事指導の特徴は？", a: "3食しっかり食べるダイエットメソッドが特徴です。極端な糖質制限ではなく、栄養バランスを考えた食事指導を行います。" },
  { q: "24/7ワークアウト心斎橋店は夜遅くまで営業していますか？", a: "深夜24時まで営業しています。仕事帰りの遅い時間でも通いやすい環境です。" },
];
...
const relatedStores = [
  ...
  { name: "24/7ワークアウト 天王寺店", href: "/review/247workout/tennoji/" },
];
  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">24/7ワークアウト 心斎橋店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">24/7ワークアウト 心斎橋店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/24/7ワークアウト+心斎橋店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
