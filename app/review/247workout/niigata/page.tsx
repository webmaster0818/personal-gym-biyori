...
export const metadata: Metadata = {
  ...
  description:
    "24/7ワークアウト 新潟店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const faqItems = [
  { q: "24/7ワークアウト新潟店の料金はいくらですか？", a: "2ヶ月コース（全16回）で月額33,000円〜の月額制プランです。入会金は無料です。最新の料金は公式サイトでご確認ください。" },
  { q: "24/7ワークアウト新潟店は完全個室ですか？", a: "はい、完全個室のマンツーマン指導です。他の利用者の目を気にせずトレーニングに集中できます。" },
  { q: "24/7ワークアウト新潟店の食事指導の特徴は？", a: "3食しっかり食べるダイエットメソッドが特徴です。極端な糖質制限ではなく、栄養バランスを考えた食事指導を行います。" },
  { q: "24/7ワークアウト新潟店は夜遅くまで営業していますか？", a: "深夜24時まで営業しています。仕事帰りの遅い時間でも通いやすい環境です。" },
];
...
const relatedStores = [
  { name: "24/7ワークアウト 高崎店", href: "/review/247workout/takasaki/" },
  { name: "24/7ワークアウト 大宮店", href: "/review/247workout/omiya/" },
  { name: "24/7ワークアウト 仙台店", href: "/review/247workout/sendai/" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="新潟店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">24/7ワークアウト 新潟店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">24/7ワークアウト 新潟店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/24/7ワークアウト+新潟店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/24/7%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%A2%E3%82%A6%E3%83%88%20%E6%96%B0%E6%BD%9F%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「産後太りの解消で通い始めました。新潟で子育てしながらでも通える時間帯の柔軟さがありがたいです。食事もしっかり食べるスタイルなので授乳中でも無理なくダイエットできました。」</p>
              <p className="text-xs text-gray-400">-- 利用歴1年半のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「朝7時から開いているので新潟での仕事前に通っています。早朝は空いていることが多く、予約も取りやすいです。手ぶらで行けるので荷物の心配がないのも助かります。」</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「3食しっかり食べていいというのが衝撃でした。新潟で他のジムも検討しましたが、食事制限が厳しくないのにしっかり痩せられるのはここだけでした。2ヶ月で7kg減です。」</p>
              <p className="text-xs text-gray-400">-- 利用歴9ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「仕事が不規則なので深夜まで営業しているのが決め手。新潟の夜遅い時間でもトレーナーさんがしっかり指導してくれます。ウェアもタオルも貸してもらえるので身軽に通えます。」</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">「完全個室なので周りの目が気にならず、集中してトレーニングできます。新潟店のトレーナーさんは褒め上手で、モチベーションを保ちやすいです。全額返金保証があるのも安心材料でした。」</p>
