    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <figure className="mt-4 mb-2 overflow-hidden rounded-xl border border-gray-200">
          <img src="/brand-ss/bbb.jpg" alt="BBB（トリプルビー）の公式サイト(スクリーンショット)" className="w-full h-auto" loading="lazy" />
        </figure>
        ...
        <nav className="mb-10 rounded-xl border border-gray-200 bg-gray-50 p-5">
          ...
          <ol className="space-y-1.5 text-sm list-decimal pl-5">
            ...
            <li><a href="#s2" className="text-teal-600 hover:underline">結論：BBB（トリプルビー）はこんな人におすすめ</a></li>
            <li><a href="#s3" className="text-teal-600 hover:underline">BBBの基本情報</a></li>
            <li><a href="#s4" className="text-teal-600 hover:underline">BBBの3つの強み</a></li>
            <li><a href="#s5" className="text-teal-600 hover:underline">BBBのメリット・デメリット</a></li>
            <li><a href="#s6" className="text-teal-600 hover:underline">BBBの料金</a></li>
            <li><a href="#s7" className="text-teal-600 hover:underline">BBBの口コミ概要</a></li>
            <li><a href="#s8" className="text-teal-600 hover:underline">BBBのよくある質問</a></li>
            <li><a href="#s9" className="text-teal-600 hover:underline">BBBが気になった方へ</a></li>
        ...
        <div className="rounded-xl border border-teal-200 bg-teal-50/60 p-5 mb-10">
          <h2 id="s2" className="font-bold text-gray-900 mb-3">結論：BBB（トリプルビー）はこんな人におすすめ</h2>
        ...
        <section className="mb-12">
          <h2 id="s3" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">BBBの基本情報</h2>
        ...
        <section className="mb-12">
          <h2 id="s4" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">BBBの3つの強み</h2>
        ...
        <section className="mb-12">
          <h2 id="s5" className="text-xl font-bold mb-6 pb-2 border-b-2 border-teal-500">BBBのメリット・デメリット</h2>
        ...
        <section className="mb-12">
          <h2 id="s6" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">BBBの料金</h2>
        ...
        <section className="mb-12">
          <h2 id="s7" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">BBBの口コミ概要</h2>
      ...
      <GymCta slug="bbb" name="BBB" />
        ...
        <section className="mb-12">
          <h2 id="s8" className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">BBBのよくある質問</h2>
        ...
        <section className="bg-teal-500 text-white rounded-xl p-8 text-center mb-10">
          <h2 id="s9" className="text-xl font-bold mb-3">BBBが気になった方へ</h2>
