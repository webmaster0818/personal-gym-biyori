...
export const metadata: Metadata = {
  ...
  description:
    "Nexusジム 馬込店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 馬込店" },
  { label: "住所", value: "東京都大田区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "馬込駅 徒歩1分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム馬込店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安料金でマンツーマンのパーソナルトレーニングが受けられます。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム馬込店の最寄駅はどこですか？", a: "馬込駅 徒歩1分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム馬込店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム馬込店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" }
];
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Nexusジム 馬込店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Nexus+ジム+馬込店"
              target="_blank"
