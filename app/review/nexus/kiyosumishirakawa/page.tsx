...
export const metadata: Metadata = {
  ...
  title: "Nexusジム 清澄白河店の口コミ・評判",
  description:
    "Nexusジム 清澄白河店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

const basicInfo = [
  { label: "店舗名", value: "Nexusジム 清澄白河店" },
  { label: "住所", value: "東京都江東区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "清澄白河駅 徒歩4分" },
  { label: "営業時間", value: "※公式サイトでご確認ください" },
  { label: "電話番号", value: "※公式サイトでご確認ください" },
];

const faqItems = [
  { q: "Nexusジム清澄白河店の料金はいくらですか？", a: "Nexusジムはコースにより料金が異なります。最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム清澄白河店の最寄駅はどこですか？", a: "清澄白河駅から徒歩4分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム清澄白河店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム清澄白河店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      <Breadcrumb items={[{ name: "口コミ・レビュー", href: "/#ranking" }, { name: "Nexusジム", href: "/review/nexus/" }, { name: "清澄白河店" }]} />
      <ReviewSummary gymName="清澄白河店" />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Nexusジム 清澄白河店の口コミ・評判</h1>
        ...
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">アクセス・地図</h2><div className="bg-gray-100 rounded-lg p-8 text-center"><p className="text-gray-600 mb-4">Nexusジム 清澄白河店の所在地をGoogleマップで確認できます。</p><a href="https://www.google.com/maps/search/Nexus+ジム+清澄白河店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a></div></section>
        <section className="mb-10"><h2 className="text-xl font-bold mb-4 pb-2 border-b-2 border-teal-500">口コミ概要</h2><p className="text-gray-700 leading-relaxed">Nexusジム清澄白河店は清澄白河駅から徒歩4分の好立地にあるパーソナルジムです。江東区エリアのおしゃれな街並みの中にあり、トレーナーの丁寧な指導と個別プログラムが好評です。初心者にも通いやすいジムです。</p><p className="text-xs text-gray-500 mt-4 bg-gray-50 rounded p-3">※口コミはGoogleマップの投稿を参考に要約・再構成したものです。個人の感想であり、効果を保証するものではありません。</p></section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20%E6%B8%85%E6%BE%84%E7%99%BD%E6%B2%B3%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額19,800円からパーソナルトレーニングが受けられるのは破格だと思います。清澄白河店のトレーナーさんは経験豊富で、毎回的確なアドバイスをくれます。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">清澄白河のNexusジムに通い始めて4ヶ月です。月額制で通い放題なので、自分のペースで週3回通っています。体重が5kg減って見た目も変わりました。</p>
