...
export const metadata: Metadata = {
  title: "Nexusジム 西馬込店の口コミ・評判",
  description:
    "Nexusジム 西馬込店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 西馬込店" },
  { label: "住所", value: "東京都大田区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "西馬込駅 徒歩4分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム西馬込店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安料金でマンツーマンのパーソナルトレーニングが受けられます。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム西馬込店の最寄駅はどこですか？", a: "西馬込駅 徒歩4分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム西馬込店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム西馬込店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" }
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "Nexusジム 蒲田/蓮沼店", href: "/review/nexus/kamata/" },
  { name: "Nexusジム 久が原店", href: "/review/nexus/kugahara/" }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Nexusジム 西馬込店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Nexus+ジム+西馬込店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20西馬込店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額19,800円〜でマンツーマンのパーソナルトレーニングが受けられるのは本当にお得です。西馬込という落ち着いた環境で集中してトレーニングできます。</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">大手パーソナルジムの半額以下で同等のサービスが受けられます。月額制なので追加料金の心配がなく安心です。</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">格安の月額制パーソナルジムを探していて見つけました。駅から近くて通いやすいのも魅力です。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">西馬込駅から徒歩4分で通いやすいです。トレーナーさんが丁寧に指導してくれるので、初心者でも安心して通えます。</p>
              <p className="text-xs text-gray-400">-- 入会2ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額制なので自分のペースで通えるのが良いです。格安なのにトレーニングの質が高く、コスパ最高です。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム西馬込店は西馬込駅から徒歩4分の好立地にあるパーソナルジムです。月額19,800円〜という格安料金でマンツーマン指導が受けられる点が好評です。大田区エリアで手頃な価格のパーソナルジムを探している方に特に支持されています。トレーナーの丁寧な指導と落ち着いた環境が口コミで高評価を得ています。
          </p>
