...
export const metadata: Metadata = {
  title: "Nexusジム 新中野店の口コミ・評判",
  description:
    "Nexusジム 新中野店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 新中野店" },
  { label: "住所", value: "東京都中野区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "新中野駅 徒歩6分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム新中野店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安料金でマンツーマンのパーソナルトレーニングが受けられます。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム新中野店の最寄駅はどこですか？", a: "新中野駅 徒歩6分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム新中野店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム新中野店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" }
];
...
/* ---------- 関連店舗 ---------- */
const relatedStores = [
  { name: "Nexusジム 西荻窪店", href: "/review/nexus/nishiogikubo/" },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Nexusジム 新中野店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Nexus+ジム+新中野店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20新中野店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">中野区で月額19,800円〜のパーソナルジムは貴重です。新中野駅から徒歩6分で通いやすいです。</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">格安の月額制でマンツーマン指導が受けられるのが決め手でした。トレーナーさんが経験豊富で信頼できます。</p>
              <p className="text-xs text-gray-400">-- 入会5ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額制なので追加料金を気にせず通えます。新中野の落ち着いた環境も良いです。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">大手の半額以下でパーソナルトレーニングが受けられます。トレーナーさんの指導が丁寧で毎回効果を実感します。</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額19,800円〜でマンツーマンのパーソナルジムに通えるのは本当にありがたいです。初心者にもおすすめです。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム新中野店は新中野駅から徒歩6分のパーソナルジムです。中野区エリアで月額19,800円〜という格安料金でマンツーマン指導が受けられます。経験豊富なトレーナーの丁寧な指導と、落ち着いた環境でのトレーニングが口コミで好評です。中野区で格安のパーソナルジムを探している方に支持されています。
          </p>
