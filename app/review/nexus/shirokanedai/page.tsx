...
export const metadata: Metadata = {
  title: "Nexusジム 白金台店の口コミ・評判",
  description:
    "Nexusジム 白金台店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 白金台店" },
  { label: "住所", value: "東京都品川区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "白金台駅 徒歩6分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム白金台店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安料金でマンツーマンのパーソナルトレーニングが受けられます。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム白金台店の最寄駅はどこですか？", a: "白金台駅 徒歩6分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム白金台店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム白金台店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Nexusジム 白金台店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Nexus+ジム+白金台店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20白金台店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">白金台エリアでこの価格のパーソナルジムがあるとは驚きです。月額19,800円〜でマンツーマン指導が受けられます。</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">高級住宅街の白金台にありながら月額制で格安なのが魅力です。トレーナーさんの指導も丁寧です。</p>
              <p className="text-xs text-gray-400">-- 入会5ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">白金台駅から徒歩6分で通えます。格安パーソナルジムですが雰囲気が良く、快適にトレーニングできます。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">大手パーソナルジムから乗り換えました。月額制で半額以下なのに指導の質は高く満足しています。</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">品川区で格安のパーソナルジムを探していて見つけました。マンツーマンなので周りを気にせずトレーニングできます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム白金台店は白金台駅から徒歩6分のパーソナルジムです。高級住宅街として知られる白金台エリアで月額19,800円〜の格安料金でマンツーマン指導が受けられる点が大きな魅力です。落ち着いた環境と丁寧なトレーナー指導が口コミで高評価を得ています。品川区エリアで格安パーソナルジムを探している方におすすめです。
          </p>
