...
export const metadata: Metadata = {
  title: "Nexusジム 大船店の口コミ・評判",
  description:
    "Nexusジム 大船店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};
...
const faqItems = [
  { q: "Nexusジム大船店の料金はいくらですか？", a: "月額19,800円〜の格安パーソナルトレーニングプランがあります。最新の料金は公式サイトでご確認ください。" },
  { q: "Nexusジム大船店の営業時間は？", a: "8:00〜22:00です。朝から夜まで幅広い時間帯でトレーニングが可能です。" },
  { q: "Nexusジム大船店は初心者でも大丈夫ですか？", a: "はい、初心者の方も多く通われています。トレーナーが一から丁寧に指導するため安心です。" },
  { q: "Nexusジム大船店の体験トレーニングはありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
...
export default function StorePage() {
  return (
    <>
      ...
      />
      <ReviewSummary gymName="大船店" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Nexusジム 大船店の口コミ・評判</h1>
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Nexusジム 大船店の所在地をGoogleマップで確認できます。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム大船店は2026年に新規オープンした神奈川県横浜市栄区の店舗です。JR大船駅からアクセスしやすく、月額19,800円〜の格安パーソナルトレーニングが魅力。大船エリアで本格的なマンツーマン指導を受けたい方にとって、コストパフォーマンスの高い選択肢です。朝8時から夜22時まで営業しているため、仕事前や仕事帰りにも通いやすい環境が整っています。
          </p>
