...
export const metadata: Metadata = {
  title: "Nexusジム 明大前店の口コミ・評判",
  description:
    "Nexusジム 明大前店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 明大前店" },
  { label: "住所", value: "東京都世田谷区（※最新情報は公式サイトでご確認ください）" },
  { label: "最寄駅", value: "明大前駅 徒歩2分" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム明大前店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安料金でマンツーマンのパーソナルトレーニングが受けられます。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム明大前店の最寄駅はどこですか？", a: "明大前駅 徒歩2分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム明大前店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム明大前店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" }
];
...
const relatedStores = [
  ...
  { name: "Nexusジム 池ノ上店", href: "/review/nexus/ikenoue/" }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">
              Nexusジム 明大前店の所在地をGoogleマップで確認できます。
            </p>
            <a
              href="https://www.google.com/maps/search/Nexus+ジム+明大前店"
              target="_blank"
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20明大前店" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">明大前駅から徒歩2分で通いやすいです。月額19,800円〜でパーソナルトレーニングが受けられるのはお得です。</p>
              <p className="text-xs text-gray-400">-- 入会3ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">学生街の明大前にありながら、本格的なマンツーマン指導が格安で受けられます。コスパ最高です。</p>
              <p className="text-xs text-gray-400">-- 入会4ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">駅から近いので仕事帰りにも通いやすいです。月額制で追加料金がかからないのが安心です。</p>
              <p className="text-xs text-gray-400">-- 入会5ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">格安の月額制パーソナルジムですが、トレーニングの質は高いです。トレーナーさんが毎回丁寧に指導してくれます。</p>
              <p className="text-xs text-gray-400">-- 入会6ヶ月のユーザー</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">世田谷区で格安のパーソナルジムを探していて見つけました。明大前駅徒歩2分という立地も便利です。</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム明大前店は明大前駅から徒歩2分の好立地にあるパーソナルジムです。月額19,800円〜の格安料金でマンツーマン指導が受けられる点が魅力です。駅チカで通いやすく、世田谷区や京王線沿線の利用者から高い評価を受けています。格安ながらトレーニングの質も高く、コスパの良さが口コミで支持されています。
          </p>
