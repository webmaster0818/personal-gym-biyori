...
export const metadata: Metadata = {
  title: "Nexusジム 渋谷店の口コミ・評判",
  description:
    "Nexusジム 渋谷店の口コミ・評判を紹介。住所・アクセス・営業時間などの基本情報から、実際の利用者の評価傾向まで詳しく解説します。",
};

/* ---------- 基本情報 ---------- */
const basicInfo = [
  { label: "店舗名", value: "Nexusジム 渋谷店" },
...
/* ---------- FAQ ---------- */
const faqItems = [
  { q: "Nexusジム渋谷店の料金はいくらですか？", a: "Nexusジムは月額19,800円〜の格安月額制パーソナルジムです。コースにより料金が異なりますので、最新の料金プランは公式サイトでご確認ください。" },
  { q: "Nexusジム渋谷店の最寄駅はどこですか？", a: "渋谷駅から徒歩約5分の立地です。詳しいアクセスは公式サイトでご確認ください。" },
  { q: "Nexusジム渋谷店のトレーナーの特徴は？", a: "資格を持つ専門トレーナーがマンツーマンで指導します。目標に合わせた個別プログラムの作成が特徴です。" },
  { q: "Nexusジム渋谷店は体験トレーニングがありますか？", a: "はい、体験トレーニングを実施しています。詳細や予約は公式サイトでご確認ください。" },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <section className="mb-10">
          ...
          <div className="bg-gray-100 rounded-lg p-8 text-center">
            <p className="text-gray-600 mb-4">Nexusジム 渋谷店の所在地をGoogleマップで確認できます。</p>
            <a href="https://www.google.com/maps/search/Nexus+ジム+渋谷店" target="_blank" rel="noopener noreferrer" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">Googleマップで見る</a>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Nexusジム渋谷店は渋谷駅から徒歩圏内にある月額制パーソナルジムです。月額19,800円〜という格安料金でマンツーマン指導を受けられる点が最大の魅力です。渋谷エリアで働く20〜30代のビジネスパーソンからの支持が高く、仕事帰りに気軽に通える利便性が評価されています。トレーナーの丁寧な指導と、無理のないプログラム設計で初心者からの評判も良い店舗です。
          </p>
        ...
        <section className="mb-10">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-yellow-700 mt-1">出典: <a href="https://www.google.com/maps/search/Nexus%E3%82%B8%E3%83%A0%20%E6%B8%8B%E8%B0%B7%E5%BA%97" target="_blank" rel="noopener noreferrer" className="underline hover:text-yellow-900">Googleマップで口コミを見る</a></p>
          </div>
          <div className="space-y-3">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">月額19,800円からパーソナルトレーニングが受けられるのは破格だと思います。渋谷店のトレーナーさんは経験豊富で、毎回的確なアドバイスをくれます。</p>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              <p className="text-sm text-gray-700 leading-relaxed mb-2">渋谷のNexusジムに通い始めて4ヶ月です。月額制で通い放題なので、自分のペースで週3回通っています。体重が5kg減って見た目も変わりました。</p>
        ...
        <section className="mb-10">
          <div className="bg-teal-50 rounded-lg p-6 text-center space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a href="https://t.felmat.net/fmcl?ak=S7941C.1.L119607K.A132329L" target="_blank" rel="noopener noreferrer nofollow" className="inline-block bg-teal-600 text-white px-6 py-3 rounded-lg hover:bg-teal-700 transition-colors">公式サイトへ</a>
            </div>
          </div>
        </section>
