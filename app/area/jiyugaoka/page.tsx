...
export const metadata: Metadata = {
  title: "【2026最新】パーソナルジム自由が丘おすすめ5選",
  description:
    "自由が丘でおすすめのパーソナルジム5選を厳選紹介。自由が丘駅周辺の料金相場・特徴・アクセスを徹底比較。女性に人気のジムも解説。",
};
...
const selectionPoints = [
  {
    title: "住宅街ならではの通いやすさを重視",
    desc: "自由が丘は住宅街として人気のエリア。自宅からの距離や通いやすさを最優先に考え、生活圏内のジムを選ぶことで長く続けられます。",
  },
  {
    title: "女性向けプログラムが充実しているか確認",
    desc: "自由が丘は女性人気の高いエリアで、女性向けのプログラムや女性専用ジムが充実しています。美容やダイエットを目的とした方にぴったりです。",
  },
  {
    title: "アットホームな雰囲気のジムを選ぶ",
    desc: "自由が丘には大手チェーンだけでなく、個人経営のアットホームなジムも多数。一人ひとりに寄り添った丁寧な指導を受けたい方におすすめです。",
  },
];
...
const gyms = [
  {
    ...
    access: "自由が丘店（自由が丘駅徒歩3分）",
    point: "入会金無料で質の高いトレーニング。自由が丘で本格ボディメイクを目指す方に。",
    reviewed: true,
    storeHref: "",
  },
  {
    ...
    access: "自由が丘店（自由が丘駅徒歩2分）",
    point: "20分で完了する時短トレーニング。お買い物ついでに立ち寄れます。",
    reviewed: true,
    storeHref: "",
  },
  {
  ...
  },
  {
    ...
    price: "月27,280円〜（月4回）",
    features: ["海外式ボディメイク", "完全個室", "手ぶらで通える", "自由が丘駅徒歩2分"],
    access: "自由が丘店（自由が丘駅徒歩2分）",
    point: "モデル体型を目指すメソッドが女性に人気。駅チカで通いやすいのも魅力です。",
    reviewed: false,
  },
  {
    name: "OUTLINE（アウトライン）",
    ...
    access: "自由が丘店（自由が丘駅徒歩5分）",
    point: "女性専用で安心。子育て中のママにも通いやすい環境が整っています。",
    reviewed: false,
  },
];

const faqItems = [
  { q: "自由が丘のパーソナルジムの料金相場はいくらですか？", a: "自由が丘のパーソナルジムの料金相場は、2ヶ月コースで20万〜38万円、月額制で3万〜8万円です。" },
  { q: "自由が丘で女性におすすめのパーソナルジムは？", a: "OUTLINE（アウトライン）は女性専用で完全個室。ベビーカー入店も可能で、子育て中の方にも人気です。" },
  { q: "自由が丘で安いパーソナルジムは？", a: "エクササイズコーチ（月9,900円〜）が最も低価格です。短時間で通えるのもメリットです。" },
  { q: "自由が丘で入会金無料のパーソナルジムは？", a: "BEYOND（ビヨンド）は入会金無料で始められます。初期費用を抑えたい方におすすめです。" },
  { q: "自由が丘のパーソナルジムは駅から近いですか？", a: "ほとんどのジムが自由が丘駅徒歩5分以内にあり、アクセスは良好です。" },
  { q: "自由が丘のパーソナルジムは体験できますか？", a: "ほとんどのジムで無料カウンセリングや体験トレーニングを実施しています。まずは体験から始めましょう。" },
];
...
export default function JiyugaokaAreaPage() {
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">【2026最新】パーソナルジム自由が丘おすすめ5選</h1>
        <p className="text-gray-500 text-sm mb-6">最終更新: 2026年4月</p>

        <p className="text-gray-700 leading-relaxed mb-10">
          自由が丘はおしゃれな街並みと住みやすさで人気のエリア。女性向けのプログラムやプライベートジムが充実しており、ライフスタイルに合わせた通い方ができます。本記事では、料金・実績・アクセスの観点から厳選した5ジムを紹介します。
        </p>
