  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <AreaGymList area="sapporo" areaName="札幌" />

        <section>
          <p className="mb-6 text-sm"><Link href="/db/sapporo/" className="underline text-teal-700 font-medium">→ 札幌のパーソナルジム全データベース(Gマップ実測・口コミ件数順)を見る</Link></p>
