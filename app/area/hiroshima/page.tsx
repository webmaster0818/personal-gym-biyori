  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-16">
        ...
        <AreaGymList area="hiroshima" areaName="広島" />

        <section>
          <p className="mb-6 text-sm"><Link href="/db/hiroshima/" className="underline text-teal-700 font-medium">→ 広島のパーソナルジム全データベース(Gマップ実測・口コミ件数順)を見る</Link></p>
